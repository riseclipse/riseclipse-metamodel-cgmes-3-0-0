 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindTurbineType4IECImpl#getWindGenType3aIEC <em>Wind Gen Type3a IEC</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WindTurbineType4IECImpl extends WindTurbineType3or4IECImpl implements WindTurbineType4IEC {
    ...
    public void setWindGenType3aIEC( WindGenType3aIEC newWindGenType3aIEC ) {
        if( newWindGenType3aIEC != windGenType3aIEC ) {
            ...
            if( newWindGenType3aIEC != null )
                msgs = ( ( InternalEObject ) newWindGenType3aIEC ).eInverseAdd( this,
                        CimPackage.WIND_GEN_TYPE3A_IEC__WIND_TURBINE_TYPE4_IEC, WindGenType3aIEC.class, msgs );
            ...
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.SET,
                        CimPackage.WIND_TURBINE_TYPE4_IEC__WIND_GEN_TYPE3A_IEC, newWindGenType3aIEC,
                        newWindGenType3aIEC, !oldWindGenType3aIECESet ) );
        }
    }
