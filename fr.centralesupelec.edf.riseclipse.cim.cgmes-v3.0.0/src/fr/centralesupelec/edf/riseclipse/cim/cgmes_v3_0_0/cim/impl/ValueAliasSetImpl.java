...
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.RaiseLowerCommand;
 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ValueAliasSetImpl#getRaiseLowerCommands <em>Raise Lower Commands</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ValueAliasSetImpl#getDiscretes <em>Discretes</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ValueAliasSetImpl#getCommands <em>Commands</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ValueAliasSetImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ValueAliasSetImpl extends IdentifiedObjectImpl implements ValueAliasSet {
    ...
    public EList< RaiseLowerCommand > getRaiseLowerCommands() {
        if( raiseLowerCommands == null ) {
            raiseLowerCommands = new EObjectWithInverseResolvingEList.Unsettable< >(
    ...
    public EList< Discrete > getDiscretes() {
        if( discretes == null ) {
            discretes = new EObjectWithInverseResolvingEList.Unsettable< >( Discrete.class, this,
    ...
    public EList< Command > getCommands() {
        if( commands == null ) {
            commands = new EObjectWithInverseResolvingEList.Unsettable< >( Command.class, this,
    ...
    public EList< ValueToAlias > getValues() {
        if( values == null ) {
            values = new EObjectWithInverseResolvingEList.Unsettable< >( ValueToAlias.class, this,
