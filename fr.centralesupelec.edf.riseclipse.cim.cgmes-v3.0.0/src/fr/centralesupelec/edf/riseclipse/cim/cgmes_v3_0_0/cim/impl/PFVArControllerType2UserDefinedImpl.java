...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>PFV Ar Controller Type2 User Defined</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.PFVArControllerType2UserDefinedImpl#getProprietaryParameterDynamics <em>Proprietary Parameter Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.PFVArControllerType2UserDefinedImpl#getProprietary <em>Proprietary</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PFVArControllerType2UserDefinedImpl extends PFVArControllerType2DynamicsImpl
        implements PFVArControllerType2UserDefined {
    /**
     ...
     * @generated
     */
    protected PFVArControllerType2UserDefinedImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return CimPackage.eINSTANCE.getPFVArControllerType2UserDefined();
    }
    ...
    public void setProprietary( Boolean newProprietary ) {
        ...
        if( eNotificationRequired() ) {
            eNotify( new ENotificationImpl( this, Notification.SET,
                    CimPackage.PFV_AR_CONTROLLER_TYPE2_USER_DEFINED__PROPRIETARY, oldProprietary, proprietary,
                    !oldProprietaryESet ) );
        }
    }
    ...
    public void unsetProprietary() {
        ...
        if( eNotificationRequired() ) {
            eNotify( new ENotificationImpl( this, Notification.UNSET,
                    CimPackage.PFV_AR_CONTROLLER_TYPE2_USER_DEFINED__PROPRIETARY, oldProprietary, PROPRIETARY_EDEFAULT,
                    oldProprietaryESet ) );
        }
    }
    ...
    public NotificationChain eInverseAdd( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        switch( featureID ) {
        case CimPackage.PFV_AR_CONTROLLER_TYPE2_USER_DEFINED__PROPRIETARY_PARAMETER_DYNAMICS:
    ...
    public Object eGet( int featureID, boolean resolve, boolean coreType ) {
        ...
        case CimPackage.PFV_AR_CONTROLLER_TYPE2_USER_DEFINED__PROPRIETARY:
...
} //PFVArControllerType2UserDefinedImpl
