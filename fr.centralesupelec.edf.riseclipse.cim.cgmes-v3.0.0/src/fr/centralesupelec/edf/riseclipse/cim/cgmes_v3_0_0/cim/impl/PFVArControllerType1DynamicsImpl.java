...
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.VoltageAdjusterDynamics;

/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>PFV Ar Controller Type1 Dynamics</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.PFVArControllerType1DynamicsImpl#getVoltageAdjusterDynamics <em>Voltage Adjuster Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.PFVArControllerType1DynamicsImpl#getRemoteInputSignal <em>Remote Input Signal</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.PFVArControllerType1DynamicsImpl#getExcitationSystemDynamics <em>Excitation System Dynamics</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PFVArControllerType1DynamicsImpl extends DynamicsFunctionBlockImpl
        implements PFVArControllerType1Dynamics {
    /**
     * The cached value of the '{@link #getVoltageAdjusterDynamics() <em>Voltage Adjuster Dynamics</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * This is true if the Voltage Adjuster Dynamics reference has been set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     * @ordered
     ...
     * @generated
     */
    protected PFVArControllerType1DynamicsImpl() {
        super();
    }
    ...
    public VoltageAdjusterDynamics getVoltageAdjusterDynamics() {
        if( voltageAdjusterDynamics != null && voltageAdjusterDynamics.eIsProxy() ) {
     ...
     * @generated
     */
    public NotificationChain basicSetVoltageAdjusterDynamics( VoltageAdjusterDynamics newVoltageAdjusterDynamics,
            NotificationChain msgs ) {
        VoltageAdjusterDynamics oldVoltageAdjusterDynamics = voltageAdjusterDynamics;
        voltageAdjusterDynamics = newVoltageAdjusterDynamics;
        boolean oldVoltageAdjusterDynamicsESet = voltageAdjusterDynamicsESet;
        voltageAdjusterDynamicsESet = true;
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    CimPackage.PFV_AR_CONTROLLER_TYPE1_DYNAMICS__VOLTAGE_ADJUSTER_DYNAMICS, oldVoltageAdjusterDynamics,
     ...
     */
    @Override
    public void setVoltageAdjusterDynamics( VoltageAdjusterDynamics newVoltageAdjusterDynamics ) {
        if( newVoltageAdjusterDynamics != voltageAdjusterDynamics ) {
            NotificationChain msgs = null;
            if( voltageAdjusterDynamics != null )
                msgs = ( ( InternalEObject ) voltageAdjusterDynamics ).eInverseRemove( this,
                        CimPackage.VOLTAGE_ADJUSTER_DYNAMICS__PFV_AR_CONTROLLER_TYPE1_DYNAMICS,
                        VoltageAdjusterDynamics.class, msgs );
            if( newVoltageAdjusterDynamics != null )
                msgs = ( ( InternalEObject ) newVoltageAdjusterDynamics ).eInverseAdd( this,
                        CimPackage.VOLTAGE_ADJUSTER_DYNAMICS__PFV_AR_CONTROLLER_TYPE1_DYNAMICS,
                        VoltageAdjusterDynamics.class, msgs );
            msgs = basicSetVoltageAdjusterDynamics( newVoltageAdjusterDynamics, msgs );
     ...
     * @generated
     */
    public NotificationChain basicUnsetVoltageAdjusterDynamics( NotificationChain msgs ) {
        VoltageAdjusterDynamics oldVoltageAdjusterDynamics = voltageAdjusterDynamics;
        voltageAdjusterDynamics = null;
        boolean oldVoltageAdjusterDynamicsESet = voltageAdjusterDynamicsESet;
        voltageAdjusterDynamicsESet = false;
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.UNSET,
                    CimPackage.PFV_AR_CONTROLLER_TYPE1_DYNAMICS__VOLTAGE_ADJUSTER_DYNAMICS, oldVoltageAdjusterDynamics,
                    null, oldVoltageAdjusterDynamicsESet );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
    ...
    public void unsetVoltageAdjusterDynamics() {
        if( voltageAdjusterDynamics != null ) {
            ...
            msgs = ( ( InternalEObject ) voltageAdjusterDynamics ).eInverseRemove( this,
                    CimPackage.VOLTAGE_ADJUSTER_DYNAMICS__PFV_AR_CONTROLLER_TYPE1_DYNAMICS,
                    VoltageAdjusterDynamics.class, msgs );
            msgs = basicUnsetVoltageAdjusterDynamics( msgs );
            if( msgs != null ) msgs.dispatch();
        }
        else {
            boolean oldVoltageAdjusterDynamicsESet = voltageAdjusterDynamicsESet;
    ...
    public boolean isSetVoltageAdjusterDynamics() {
        return voltageAdjusterDynamicsESet;
    }
    ...
    public RemoteInputSignal getRemoteInputSignal() {
        if( remoteInputSignal != null && remoteInputSignal.eIsProxy() ) {
            ...
            if( remoteInputSignal != oldRemoteInputSignal ) {
                if( eNotificationRequired() )
                    eNotify( new ENotificationImpl( this, Notification.RESOLVE,
                            CimPackage.PFV_AR_CONTROLLER_TYPE1_DYNAMICS__REMOTE_INPUT_SIGNAL, oldRemoteInputSignal,
                            remoteInputSignal ) );
            }
        }
    ...
    public NotificationChain basicUnsetRemoteInputSignal( NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.UNSET,
                    CimPackage.PFV_AR_CONTROLLER_TYPE1_DYNAMICS__REMOTE_INPUT_SIGNAL, oldRemoteInputSignal, null,
    ...
    public NotificationChain eInverseAdd( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        switch( featureID ) {
        case CimPackage.PFV_AR_CONTROLLER_TYPE1_DYNAMICS__VOLTAGE_ADJUSTER_DYNAMICS:
            if( voltageAdjusterDynamics != null )
                msgs = ( ( InternalEObject ) voltageAdjusterDynamics ).eInverseRemove( this,
                        CimPackage.VOLTAGE_ADJUSTER_DYNAMICS__PFV_AR_CONTROLLER_TYPE1_DYNAMICS,
                        VoltageAdjusterDynamics.class, msgs );
            return basicSetVoltageAdjusterDynamics( ( VoltageAdjusterDynamics ) otherEnd, msgs );
    ...
    public NotificationChain eInverseRemove( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        switch( featureID ) {
        case CimPackage.PFV_AR_CONTROLLER_TYPE1_DYNAMICS__VOLTAGE_ADJUSTER_DYNAMICS:
            return basicUnsetVoltageAdjusterDynamics( msgs );
        case CimPackage.PFV_AR_CONTROLLER_TYPE1_DYNAMICS__REMOTE_INPUT_SIGNAL:
    ...
    public Object eGet( int featureID, boolean resolve, boolean coreType ) {
        switch( featureID ) {
        case CimPackage.PFV_AR_CONTROLLER_TYPE1_DYNAMICS__VOLTAGE_ADJUSTER_DYNAMICS:
            if( resolve ) return getVoltageAdjusterDynamics();
            return basicGetVoltageAdjusterDynamics();
        case CimPackage.PFV_AR_CONTROLLER_TYPE1_DYNAMICS__REMOTE_INPUT_SIGNAL:
    ...
    public void eSet( int featureID, Object newValue ) {
        switch( featureID ) {
        case CimPackage.PFV_AR_CONTROLLER_TYPE1_DYNAMICS__VOLTAGE_ADJUSTER_DYNAMICS:
            setVoltageAdjusterDynamics( ( VoltageAdjusterDynamics ) newValue );
            return;
        case CimPackage.PFV_AR_CONTROLLER_TYPE1_DYNAMICS__REMOTE_INPUT_SIGNAL:
...
} //PFVArControllerType1DynamicsImpl
