 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.AsynchronousMachineDynamicsImpl#getAsynchronousMachine <em>Asynchronous Machine</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.AsynchronousMachineDynamicsImpl#getWindTurbineType1or2Dynamics <em>Wind Turbine Type1or2 Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.AsynchronousMachineDynamicsImpl#getTurbineGovernorDynamics <em>Turbine Governor Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.AsynchronousMachineDynamicsImpl#getMechanicalLoadDynamics <em>Mechanical Load Dynamics</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AsynchronousMachineDynamicsImpl extends RotatingMachineDynamicsImpl
    ...
    public TurbineGovernorDynamics getTurbineGovernorDynamics() {
        if( turbineGovernorDynamics != null && turbineGovernorDynamics.eIsProxy() ) {
    ...
    public Object eGet( int featureID, boolean resolve, boolean coreType ) {
        ...
        case CimPackage.ASYNCHRONOUS_MACHINE_DYNAMICS__TURBINE_GOVERNOR_DYNAMICS:
            if( resolve ) return getTurbineGovernorDynamics();
            return basicGetTurbineGovernorDynamics();
        case CimPackage.ASYNCHRONOUS_MACHINE_DYNAMICS__MECHANICAL_LOAD_DYNAMICS:
