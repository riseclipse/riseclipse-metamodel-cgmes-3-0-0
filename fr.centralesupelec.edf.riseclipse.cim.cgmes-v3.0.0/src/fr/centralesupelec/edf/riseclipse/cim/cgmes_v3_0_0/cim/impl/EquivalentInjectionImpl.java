 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.EquivalentInjectionImpl#getMaxP <em>Max P</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.EquivalentInjectionImpl#getMaxQ <em>Max Q</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.EquivalentInjectionImpl#getReactiveCapabilityCurve <em>Reactive Capability Curve</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.EquivalentInjectionImpl#getMinP <em>Min P</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.EquivalentInjectionImpl#getMinQ <em>Min Q</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.EquivalentInjectionImpl#getRegulationCapability <em>Regulation Capability</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.EquivalentInjectionImpl#getX2 <em>X2</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.EquivalentInjectionImpl#getX0 <em>X0</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.EquivalentInjectionImpl#getR <em>R</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.EquivalentInjectionImpl#getX <em>X</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.EquivalentInjectionImpl#getR2 <em>R2</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.EquivalentInjectionImpl#getR0 <em>R0</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.EquivalentInjectionImpl#getP <em>P</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.EquivalentInjectionImpl#getQ <em>Q</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.EquivalentInjectionImpl#getRegulationStatus <em>Regulation Status</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.EquivalentInjectionImpl#getRegulationTarget <em>Regulation Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EquivalentInjectionImpl extends EquivalentEquipmentImpl implements EquivalentInjection {
     ...
     * @ordered
     */
    protected static final Double REGULATION_TARGET_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double regulationTarget = REGULATION_TARGET_EDEFAULT;
     ...
     */
    @Override
    public void setRegulationTarget( Double newRegulationTarget ) {
        Double oldRegulationTarget = regulationTarget;
    ...
    public void eSet( int featureID, Object newValue ) {
        ...
        case CimPackage.EQUIVALENT_INJECTION__REGULATION_STATUS:
            ...
            return;
        case CimPackage.EQUIVALENT_INJECTION__REGULATION_TARGET:
            setRegulationTarget( ( Double ) newValue );
            return;
        }
