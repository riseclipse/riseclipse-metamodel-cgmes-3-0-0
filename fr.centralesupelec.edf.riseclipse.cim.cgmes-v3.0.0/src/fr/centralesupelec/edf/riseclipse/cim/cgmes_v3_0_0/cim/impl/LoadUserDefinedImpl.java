...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Load User Defined</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.LoadUserDefinedImpl#getProprietary <em>Proprietary</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.LoadUserDefinedImpl#getProprietaryParameterDynamics <em>Proprietary Parameter Dynamics</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LoadUserDefinedImpl extends LoadDynamicsImpl implements LoadUserDefined {
    /**
    ...
    protected EClass eStaticClass() {
        return CimPackage.eINSTANCE.getLoadUserDefined();
    }
    ...
    public EList< ProprietaryParameterDynamics > getProprietaryParameterDynamics() {
        if( proprietaryParameterDynamics == null ) {
            proprietaryParameterDynamics = new EObjectWithInverseResolvingEList.Unsettable< >(
                    ...
                    CimPackage.LOAD_USER_DEFINED__PROPRIETARY_PARAMETER_DYNAMICS,
                    CimPackage.PROPRIETARY_PARAMETER_DYNAMICS__LOAD_USER_DEFINED );
        }
    ...
    public NotificationChain eInverseAdd( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        switch( featureID ) {
        case CimPackage.LOAD_USER_DEFINED__PROPRIETARY_PARAMETER_DYNAMICS:
