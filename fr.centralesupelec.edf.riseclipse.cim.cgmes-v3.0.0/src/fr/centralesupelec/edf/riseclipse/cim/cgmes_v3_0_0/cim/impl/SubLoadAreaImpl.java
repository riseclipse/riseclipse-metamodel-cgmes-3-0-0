 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.SubLoadAreaImpl#getLoadGroups <em>Load Groups</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.SubLoadAreaImpl#getLoadArea <em>Load Area</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubLoadAreaImpl extends EnergyAreaImpl implements SubLoadArea {
    ...
    public EList< LoadGroup > getLoadGroups() {
        if( loadGroups == null ) {
            loadGroups = new EObjectWithInverseResolvingEList.Unsettable< >( LoadGroup.class, this,
