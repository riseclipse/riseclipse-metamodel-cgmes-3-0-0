 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.AnalogLimitSetImpl#getMeasurements <em>Measurements</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.AnalogLimitSetImpl#getLimits <em>Limits</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnalogLimitSetImpl extends LimitSetImpl implements AnalogLimitSet {
    ...
    public EList< Analog > getMeasurements() {
        if( measurements == null ) {
            measurements = new EObjectWithInverseEList.Unsettable.ManyInverse< >( Analog.class, this,
    ...
    public EList< AnalogLimit > getLimits() {
        if( limits == null ) {
            limits = new EObjectWithInverseResolvingEList.Unsettable< >( AnalogLimit.class, this,
