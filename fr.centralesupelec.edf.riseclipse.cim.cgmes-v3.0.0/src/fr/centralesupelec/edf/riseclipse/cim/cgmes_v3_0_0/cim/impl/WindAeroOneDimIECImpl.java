 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindAeroOneDimIECImpl#getThetaomega <em>Thetaomega</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindAeroOneDimIECImpl#getKa <em>Ka</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindAeroOneDimIECImpl#getWindTurbineType3IEC <em>Wind Turbine Type3 IEC</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WindAeroOneDimIECImpl extends IdentifiedObjectImpl implements WindAeroOneDimIEC {
     ...
     * @ordered
     */
    protected static final Double THETAOMEGA_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double thetaomega = THETAOMEGA_EDEFAULT;
     ...
     */
    @Override
    public void setThetaomega( Double newThetaomega ) {
        Double oldThetaomega = thetaomega;
        thetaomega = newThetaomega;
        boolean oldThetaomegaESet = thetaomegaESet;
        thetaomegaESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.WIND_AERO_ONE_DIM_IEC__THETAOMEGA,
                    oldThetaomega, thetaomega, !oldThetaomegaESet ) );
    }
    ...
    public void unsetThetaomega() {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.WIND_AERO_ONE_DIM_IEC__THETAOMEGA,
                    oldThetaomega, THETAOMEGA_EDEFAULT, oldThetaomegaESet ) );
    }
    ...
    public void setKa( Double newKa ) {
        ...
        kaESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.WIND_AERO_ONE_DIM_IEC__KA, oldKa, ka,
                    !oldKaESet ) );
    }
    ...
    public void unsetKa() {
        ...
        kaESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.WIND_AERO_ONE_DIM_IEC__KA, oldKa,
                    KA_EDEFAULT, oldKaESet ) );
    }
