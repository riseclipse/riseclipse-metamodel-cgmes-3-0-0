...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Power System Stabilizer User Defined</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.PowerSystemStabilizerUserDefinedImpl#getProprietaryParameterDynamics <em>Proprietary Parameter Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.PowerSystemStabilizerUserDefinedImpl#getProprietary <em>Proprietary</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PowerSystemStabilizerUserDefinedImpl extends PowerSystemStabilizerDynamicsImpl
        implements PowerSystemStabilizerUserDefined {
    /**
     ...
     * @generated
     */
    protected PowerSystemStabilizerUserDefinedImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return CimPackage.eINSTANCE.getPowerSystemStabilizerUserDefined();
    }
    ...
    public void setProprietary( Boolean newProprietary ) {
        ...
        if( eNotificationRequired() ) {
            eNotify( new ENotificationImpl( this, Notification.SET,
                    CimPackage.POWER_SYSTEM_STABILIZER_USER_DEFINED__PROPRIETARY, oldProprietary, proprietary,
                    !oldProprietaryESet ) );
        }
    }
    ...
    public void unsetProprietary() {
        ...
        if( eNotificationRequired() ) {
            eNotify( new ENotificationImpl( this, Notification.UNSET,
                    CimPackage.POWER_SYSTEM_STABILIZER_USER_DEFINED__PROPRIETARY, oldProprietary, PROPRIETARY_EDEFAULT,
                    oldProprietaryESet ) );
        }
    }
    ...
    public NotificationChain eInverseAdd( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        switch( featureID ) {
        case CimPackage.POWER_SYSTEM_STABILIZER_USER_DEFINED__PROPRIETARY_PARAMETER_DYNAMICS:
...
} //PowerSystemStabilizerUserDefinedImpl
