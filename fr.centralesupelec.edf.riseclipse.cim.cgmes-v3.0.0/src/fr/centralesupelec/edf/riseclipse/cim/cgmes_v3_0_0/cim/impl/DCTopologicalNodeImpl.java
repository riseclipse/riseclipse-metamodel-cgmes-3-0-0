...
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.DCBaseTerminal;
 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.DCTopologicalNodeImpl#getDCTopologicalIsland <em>DC Topological Island</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.DCTopologicalNodeImpl#getDCEquipmentContainer <em>DC Equipment Container</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.DCTopologicalNodeImpl#getDCNodes <em>DC Nodes</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.DCTopologicalNodeImpl#getDCTerminals <em>DC Terminals</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DCTopologicalNodeImpl extends IdentifiedObjectImpl implements DCTopologicalNode {
    ...
    public DCTopologicalIsland getDCTopologicalIsland() {
        if( dcTopologicalIsland != null && dcTopologicalIsland.eIsProxy() ) {
            InternalEObject oldDCTopologicalIsland = ( InternalEObject ) dcTopologicalIsland;
            dcTopologicalIsland = ( DCTopologicalIsland ) eResolveProxy( oldDCTopologicalIsland );
            if( dcTopologicalIsland != oldDCTopologicalIsland ) {
     ...
     * @generated
     */
    public DCTopologicalIsland basicGetDCTopologicalIsland() {
        return dcTopologicalIsland;
    }
        ...
        if( dcTopologicalIsland != null ) {
            ...
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET,
                        CimPackage.DC_TOPOLOGICAL_NODE__DC_TOPOLOGICAL_ISLAND, null, null,
                        oldDCTopologicalIslandESet ) );
        }
    }
    ...
    public void unsetDCEquipmentContainer() {
        if( dcEquipmentContainer != null ) {
            ...
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET,
                        CimPackage.DC_TOPOLOGICAL_NODE__DC_EQUIPMENT_CONTAINER, null, null,
                        oldDCEquipmentContainerESet ) );
        }
    }
    ...
    public EList< DCBaseTerminal > getDCTerminals() {
        if( dcTerminals == null ) {
            dcTerminals = new EObjectWithInverseResolvingEList.Unsettable< >( DCBaseTerminal.class, this,
    ...
    public Object eGet( int featureID, boolean resolve, boolean coreType ) {
        switch( featureID ) {
        case CimPackage.DC_TOPOLOGICAL_NODE__DC_TOPOLOGICAL_ISLAND:
            if( resolve ) return getDCTopologicalIsland();
            return basicGetDCTopologicalIsland();
        case CimPackage.DC_TOPOLOGICAL_NODE__DC_EQUIPMENT_CONTAINER:
