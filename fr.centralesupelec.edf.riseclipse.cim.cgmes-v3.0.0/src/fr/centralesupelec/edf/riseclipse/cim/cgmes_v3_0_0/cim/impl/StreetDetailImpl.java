 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.StreetDetailImpl#getSuiteNumber <em>Suite Number</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.StreetDetailImpl#getType <em>Type</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.StreetDetailImpl#getBuildingName <em>Building Name</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.StreetDetailImpl#getPrefix <em>Prefix</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.StreetDetailImpl#getAddressGeneral <em>Address General</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.StreetDetailImpl#getAddressGeneral2 <em>Address General2</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.StreetDetailImpl#getAddressGeneral3 <em>Address General3</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.StreetDetailImpl#getSuffix <em>Suffix</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.StreetDetailImpl#getCode <em>Code</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.StreetDetailImpl#getNumber <em>Number</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.StreetDetailImpl#getWithinTownLimits <em>Within Town Limits</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.StreetDetailImpl#getFloorIdentification <em>Floor Identification</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.StreetDetailImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StreetDetailImpl extends MinimalEObjectImpl.Container implements StreetDetail {
    ...
    /**
     * The default value of the '{@link #getFloorIdentification() <em>Floor Identification</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @ordered
     */
    protected static final String FLOOR_IDENTIFICATION_EDEFAULT = null;

    /**
     * The cached value of the '{@link #getFloorIdentification() <em>Floor Identification</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #getFloorIdentification()
     * @generated
     * @ordered
     */
    protected String floorIdentification = FLOOR_IDENTIFICATION_EDEFAULT;

    /**
     * This is true if the Floor Identification attribute has been set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     * @ordered
     */
    protected boolean floorIdentificationESet;
     ...
     */
    @Override
    public void setFloorIdentification( String newFloorIdentification ) {
        String oldFloorIdentification = floorIdentification;
        floorIdentification = newFloorIdentification;
        boolean oldFloorIdentificationESet = floorIdentificationESet;
        floorIdentificationESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.STREET_DETAIL__FLOOR_IDENTIFICATION,
                    oldFloorIdentification, floorIdentification, !oldFloorIdentificationESet ) );
    }
     ...
     */
    @Override
    public void unsetFloorIdentification() {
        String oldFloorIdentification = floorIdentification;
        boolean oldFloorIdentificationESet = floorIdentificationESet;
        floorIdentification = FLOOR_IDENTIFICATION_EDEFAULT;
        floorIdentificationESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.STREET_DETAIL__FLOOR_IDENTIFICATION,
                    oldFloorIdentification, FLOOR_IDENTIFICATION_EDEFAULT, oldFloorIdentificationESet ) );
    }
     ...
     */
    @Override
    public boolean isSetFloorIdentification() {
        return floorIdentificationESet;
    }
    ...
    public Object eGet( int featureID, boolean resolve, boolean coreType ) {
        ...
        case CimPackage.STREET_DETAIL__FLOOR_IDENTIFICATION:
            return getFloorIdentification();
    ...
    public void eSet( int featureID, Object newValue ) {
        ...
        case CimPackage.STREET_DETAIL__WITHIN_TOWN_LIMITS:
            ...
            return;
        case CimPackage.STREET_DETAIL__FLOOR_IDENTIFICATION:
            setFloorIdentification( ( String ) newValue );
            return;
        case CimPackage.STREET_DETAIL__NAME:
    ...
    public boolean eIsSet( int featureID ) {
        ...
        case CimPackage.STREET_DETAIL__FLOOR_IDENTIFICATION:
            return isSetFloorIdentification();
        case CimPackage.STREET_DETAIL__NAME:
            return isSetName();
        }
    ...
    public String toString() {
        ...
        if( withinTownLimitsESet )
            ...
            result.append( "<unset>" );
        result.append( ", floorIdentification: " );
        if( floorIdentificationESet )
            result.append( floorIdentification );
        else
            result.append( "<unset>" );
        result.append( ", name: " );
