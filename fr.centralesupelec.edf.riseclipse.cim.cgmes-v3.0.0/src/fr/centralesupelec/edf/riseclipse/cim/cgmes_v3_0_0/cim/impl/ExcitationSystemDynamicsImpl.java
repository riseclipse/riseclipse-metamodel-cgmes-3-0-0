...
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.OverexcitationLimiterDynamics;
 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcitationSystemDynamicsImpl#getUnderexcitationLimiterDynamics <em>Underexcitation Limiter Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcitationSystemDynamicsImpl#getPFVArControllerType2Dynamics <em>PFV Ar Controller Type2 Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcitationSystemDynamicsImpl#getDiscontinuousExcitationControlDynamics <em>Discontinuous Excitation Control Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcitationSystemDynamicsImpl#getSynchronousMachineDynamics <em>Synchronous Machine Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcitationSystemDynamicsImpl#getPFVArControllerType1Dynamics <em>PFV Ar Controller Type1 Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcitationSystemDynamicsImpl#getOverexcitationLimiterDynamics <em>Overexcitation Limiter Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcitationSystemDynamicsImpl#getPowerSystemStabilizerDynamics <em>Power System Stabilizer Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcitationSystemDynamicsImpl#getVoltageCompensatorDynamics <em>Voltage Compensator Dynamics</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExcitationSystemDynamicsImpl extends DynamicsFunctionBlockImpl implements ExcitationSystemDynamics {
    ...
    public PFVArControllerType2Dynamics getPFVArControllerType2Dynamics() {
        if( pfvArControllerType2Dynamics != null && pfvArControllerType2Dynamics.eIsProxy() ) {
            InternalEObject oldPFVArControllerType2Dynamics = ( InternalEObject ) pfvArControllerType2Dynamics;
            pfvArControllerType2Dynamics = ( PFVArControllerType2Dynamics ) eResolveProxy(
                    oldPFVArControllerType2Dynamics );
            if( pfvArControllerType2Dynamics != oldPFVArControllerType2Dynamics ) {
                if( eNotificationRequired() )
                    eNotify( new ENotificationImpl( this, Notification.RESOLVE,
                            CimPackage.EXCITATION_SYSTEM_DYNAMICS__PFV_AR_CONTROLLER_TYPE2_DYNAMICS,
                            oldPFVArControllerType2Dynamics, pfvArControllerType2Dynamics ) );
            }
        }
     ...
     * @generated
     */
    public PFVArControllerType2Dynamics basicGetPFVArControllerType2Dynamics() {
        return pfvArControllerType2Dynamics;
    }
    ...
    public PowerSystemStabilizerDynamics getPowerSystemStabilizerDynamics() {
        if( powerSystemStabilizerDynamics != null && powerSystemStabilizerDynamics.eIsProxy() ) {
            InternalEObject oldPowerSystemStabilizerDynamics = ( InternalEObject ) powerSystemStabilizerDynamics;
    ...
    public Object eGet( int featureID, boolean resolve, boolean coreType ) {
        ...
        case CimPackage.EXCITATION_SYSTEM_DYNAMICS__PFV_AR_CONTROLLER_TYPE2_DYNAMICS:
            if( resolve ) return getPFVArControllerType2Dynamics();
            return basicGetPFVArControllerType2Dynamics();
        case CimPackage.EXCITATION_SYSTEM_DYNAMICS__DISCONTINUOUS_EXCITATION_CONTROL_DYNAMICS:
        ...
        case CimPackage.EXCITATION_SYSTEM_DYNAMICS__POWER_SYSTEM_STABILIZER_DYNAMICS:
            if( resolve ) return getPowerSystemStabilizerDynamics();
            return basicGetPowerSystemStabilizerDynamics();
        case CimPackage.EXCITATION_SYSTEM_DYNAMICS__VOLTAGE_COMPENSATOR_DYNAMICS:
