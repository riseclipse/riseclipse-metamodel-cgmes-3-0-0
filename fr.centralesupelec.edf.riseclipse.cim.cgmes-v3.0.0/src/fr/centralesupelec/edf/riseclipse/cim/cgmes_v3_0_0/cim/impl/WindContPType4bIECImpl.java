...
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.WindContPType4bIEC;
 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindContPType4bIECImpl#getWindTurbineType4bIEC <em>Wind Turbine Type4b IEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindContPType4bIECImpl#getTpordp4b <em>Tpordp4b</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindContPType4bIECImpl#getTufiltp4b <em>Tufiltp4b</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindContPType4bIECImpl#getDpmaxp4b <em>Dpmaxp4b</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindContPType4bIECImpl#getTpaero <em>Tpaero</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WindContPType4bIECImpl extends IdentifiedObjectImpl implements WindContPType4bIEC {
     ...
     * @ordered
     */
    protected static final Double TPORDP4B_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double tpordp4b = TPORDP4B_EDEFAULT;
     ...
     * @ordered
     */
    protected static final Double TUFILTP4B_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double tufiltp4b = TUFILTP4B_EDEFAULT;
     ...
     * @ordered
     */
    protected static final Double DPMAXP4B_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double dpmaxp4b = DPMAXP4B_EDEFAULT;
     ...
     * @ordered
     */
    protected static final Double TPAERO_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double tpaero = TPAERO_EDEFAULT;
     ...
     */
    @Override
    public void setTpordp4b( Double newTpordp4b ) {
        Double oldTpordp4b = tpordp4b;
        tpordp4b = newTpordp4b;
        boolean oldTpordp4bESet = tpordp4bESet;
        tpordp4bESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.WIND_CONT_PTYPE4B_IEC__TPORDP4B,
                    oldTpordp4b, tpordp4b, !oldTpordp4bESet ) );
    }
    ...
    public void unsetTpordp4b() {
        ...
        tpordp4bESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.WIND_CONT_PTYPE4B_IEC__TPORDP4B,
                    oldTpordp4b, TPORDP4B_EDEFAULT, oldTpordp4bESet ) );
    }
     ...
     */
    @Override
    public void setTufiltp4b( Double newTufiltp4b ) {
        Double oldTufiltp4b = tufiltp4b;
        tufiltp4b = newTufiltp4b;
        boolean oldTufiltp4bESet = tufiltp4bESet;
        tufiltp4bESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.WIND_CONT_PTYPE4B_IEC__TUFILTP4B,
                    oldTufiltp4b, tufiltp4b, !oldTufiltp4bESet ) );
    }
    ...
    public void unsetTufiltp4b() {
        ...
        tufiltp4bESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.WIND_CONT_PTYPE4B_IEC__TUFILTP4B,
                    oldTufiltp4b, TUFILTP4B_EDEFAULT, oldTufiltp4bESet ) );
    }
     ...
     */
    @Override
    public void setDpmaxp4b( Double newDpmaxp4b ) {
        Double oldDpmaxp4b = dpmaxp4b;
        dpmaxp4b = newDpmaxp4b;
        boolean oldDpmaxp4bESet = dpmaxp4bESet;
        dpmaxp4bESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.WIND_CONT_PTYPE4B_IEC__DPMAXP4B,
                    oldDpmaxp4b, dpmaxp4b, !oldDpmaxp4bESet ) );
    }
    ...
    public void unsetDpmaxp4b() {
        ...
        dpmaxp4bESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.WIND_CONT_PTYPE4B_IEC__DPMAXP4B,
                    oldDpmaxp4b, DPMAXP4B_EDEFAULT, oldDpmaxp4bESet ) );
    }
     ...
     */
    @Override
    public void setTpaero( Double newTpaero ) {
        Double oldTpaero = tpaero;
        tpaero = newTpaero;
    ...
    public void eSet( int featureID, Object newValue ) {
        ...
        case CimPackage.WIND_CONT_PTYPE4B_IEC__WIND_TURBINE_TYPE4B_IEC:
            ...
            return;
        case CimPackage.WIND_CONT_PTYPE4B_IEC__TPORDP4B:
            setTpordp4b( ( Double ) newValue );
            return;
        case CimPackage.WIND_CONT_PTYPE4B_IEC__TUFILTP4B:
            setTufiltp4b( ( Double ) newValue );
            return;
        case CimPackage.WIND_CONT_PTYPE4B_IEC__DPMAXP4B:
            setDpmaxp4b( ( Double ) newValue );
            return;
        case CimPackage.WIND_CONT_PTYPE4B_IEC__TPAERO:
            setTpaero( ( Double ) newValue );
            return;
        }
