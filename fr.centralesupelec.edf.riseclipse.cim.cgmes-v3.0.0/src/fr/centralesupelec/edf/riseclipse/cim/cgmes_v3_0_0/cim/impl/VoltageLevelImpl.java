 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.VoltageLevelImpl#getSubstation <em>Substation</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.VoltageLevelImpl#getLowVoltageLimit <em>Low Voltage Limit</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.VoltageLevelImpl#getBaseVoltage <em>Base Voltage</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.VoltageLevelImpl#getHighVoltageLimit <em>High Voltage Limit</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.VoltageLevelImpl#getBays <em>Bays</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VoltageLevelImpl extends EquipmentContainerImpl implements VoltageLevel {
     ...
     * @ordered
     */
    protected static final Double LOW_VOLTAGE_LIMIT_EDEFAULT = null;
     ...
     * @ordered
     */
    protected static final Double HIGH_VOLTAGE_LIMIT_EDEFAULT = null;
    ...
    public EList< Bay > getBays() {
        if( bays == null ) {
            bays = new EObjectWithInverseResolvingEList.Unsettable< >( Bay.class, this,
    ...
    public void unsetBays() {
        if( bays != null ) {
            ( ( InternalEList.Unsettable< ? > ) bays ).unset();
        }
    }
