...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Voltage Compensator User Defined</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.VoltageCompensatorUserDefinedImpl#getProprietaryParameterDynamics <em>Proprietary Parameter Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.VoltageCompensatorUserDefinedImpl#getProprietary <em>Proprietary</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VoltageCompensatorUserDefinedImpl extends VoltageCompensatorDynamicsImpl
        implements VoltageCompensatorUserDefined {
    /**
     ...
     * @generated
     */
    protected VoltageCompensatorUserDefinedImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return CimPackage.eINSTANCE.getVoltageCompensatorUserDefined();
    }
    ...
    public void setProprietary( Boolean newProprietary ) {
        ...
        if( eNotificationRequired() ) {
            eNotify( new ENotificationImpl( this, Notification.SET,
                    CimPackage.VOLTAGE_COMPENSATOR_USER_DEFINED__PROPRIETARY, oldProprietary, proprietary,
                    !oldProprietaryESet ) );
        }
    }
    ...
    public void unsetProprietary() {
        ...
        if( eNotificationRequired() ) {
            eNotify( new ENotificationImpl( this, Notification.UNSET,
                    CimPackage.VOLTAGE_COMPENSATOR_USER_DEFINED__PROPRIETARY, oldProprietary, PROPRIETARY_EDEFAULT,
                    oldProprietaryESet ) );
        }
    }
    ...
    public NotificationChain eInverseAdd( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        switch( featureID ) {
        case CimPackage.VOLTAGE_COMPENSATOR_USER_DEFINED__PROPRIETARY_PARAMETER_DYNAMICS:
    ...
    public Object eGet( int featureID, boolean resolve, boolean coreType ) {
        ...
        case CimPackage.VOLTAGE_COMPENSATOR_USER_DEFINED__PROPRIETARY:
...
} //VoltageCompensatorUserDefinedImpl
