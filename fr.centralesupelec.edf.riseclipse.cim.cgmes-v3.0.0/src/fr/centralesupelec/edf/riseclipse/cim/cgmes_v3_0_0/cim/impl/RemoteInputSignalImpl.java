...
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.DiscontinuousExcitationControlDynamics;
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.PFVArControllerType1Dynamics;
...
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.RemoteSignalKind;
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.Terminal;
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.UnderexcitationLimiterDynamics;
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.VoltageCompensatorDynamics;
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.WindPlantDynamics;
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.WindTurbineType1or2Dynamics;
 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.RemoteInputSignalImpl#getRemoteSignalType <em>Remote Signal Type</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.RemoteInputSignalImpl#getWindTurbineType1or2Dynamics <em>Wind Turbine Type1or2 Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.RemoteInputSignalImpl#getPFVArControllerType1Dynamics <em>PFV Ar Controller Type1 Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.RemoteInputSignalImpl#getVoltageCompensatorDynamics <em>Voltage Compensator Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.RemoteInputSignalImpl#getUnderexcitationLimiterDynamics <em>Underexcitation Limiter Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.RemoteInputSignalImpl#getDiscontinuousExcitationControlDynamics <em>Discontinuous Excitation Control Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.RemoteInputSignalImpl#getTerminal <em>Terminal</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.RemoteInputSignalImpl#getWindTurbineType3or4Dynamics <em>Wind Turbine Type3or4 Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.RemoteInputSignalImpl#getPowerSystemStabilizerDynamics <em>Power System Stabilizer Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.RemoteInputSignalImpl#getWindPlantDynamics <em>Wind Plant Dynamics</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RemoteInputSignalImpl extends IdentifiedObjectImpl implements RemoteInputSignal {
    ...
    public WindTurbineType1or2Dynamics getWindTurbineType1or2Dynamics() {
        if( windTurbineType1or2Dynamics != null && windTurbineType1or2Dynamics.eIsProxy() ) {
            InternalEObject oldWindTurbineType1or2Dynamics = ( InternalEObject ) windTurbineType1or2Dynamics;
    ...
    public WindPlantDynamics getWindPlantDynamics() {
        if( windPlantDynamics != null && windPlantDynamics.eIsProxy() ) {
            InternalEObject oldWindPlantDynamics = ( InternalEObject ) windPlantDynamics;
            windPlantDynamics = ( WindPlantDynamics ) eResolveProxy( oldWindPlantDynamics );
            if( windPlantDynamics != oldWindPlantDynamics ) {
                if( eNotificationRequired() )
                    eNotify( new ENotificationImpl( this, Notification.RESOLVE,
                            CimPackage.REMOTE_INPUT_SIGNAL__WIND_PLANT_DYNAMICS, oldWindPlantDynamics,
                            windPlantDynamics ) );
            }
        }
     ...
     * @generated
     */
    public WindPlantDynamics basicGetWindPlantDynamics() {
        return windPlantDynamics;
    }
    ...
    public Object eGet( int featureID, boolean resolve, boolean coreType ) {
        ...
        case CimPackage.REMOTE_INPUT_SIGNAL__WIND_TURBINE_TYPE1OR2_DYNAMICS:
            if( resolve ) return getWindTurbineType1or2Dynamics();
            return basicGetWindTurbineType1or2Dynamics();
        case CimPackage.REMOTE_INPUT_SIGNAL__PFV_AR_CONTROLLER_TYPE1_DYNAMICS:
        ...
        case CimPackage.REMOTE_INPUT_SIGNAL__WIND_PLANT_DYNAMICS:
            if( resolve ) return getWindPlantDynamics();
            return basicGetWindPlantDynamics();
        }
