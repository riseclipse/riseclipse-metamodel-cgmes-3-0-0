...
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.DiagramObjectStyle;
 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.DiagramObjectImpl#getRotation <em>Rotation</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.DiagramObjectImpl#getDiagramObjectStyle <em>Diagram Object Style</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.DiagramObjectImpl#getIdentifiedObject <em>Identified Object</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.DiagramObjectImpl#getIsPolygon <em>Is Polygon</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.DiagramObjectImpl#getDrawingOrder <em>Drawing Order</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.DiagramObjectImpl#getOffsetY <em>Offset Y</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.DiagramObjectImpl#getOffsetX <em>Offset X</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.DiagramObjectImpl#getDiagram <em>Diagram</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.DiagramObjectImpl#getVisibilityLayers <em>Visibility Layers</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.DiagramObjectImpl#getDiagramObjectPoints <em>Diagram Object Points</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiagramObjectImpl extends IdentifiedObjectImpl implements DiagramObject {
     ...
     * @ordered
     */
    protected static final Double OFFSET_Y_EDEFAULT = null;
     ...
     * @ordered
     */
    protected static final Double OFFSET_X_EDEFAULT = null;
    ...
    public EList< VisibilityLayer > getVisibilityLayers() {
        if( visibilityLayers == null ) {
            visibilityLayers = new EObjectWithInverseResolvingEList.Unsettable.ManyInverse< >(
    ...
    public EList< DiagramObjectPoint > getDiagramObjectPoints() {
        if( diagramObjectPoints == null ) {
            diagramObjectPoints = new EObjectWithInverseResolvingEList.Unsettable< >(
