 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.PhaseTapChangerTableImpl#getPhaseTapChangerTabular <em>Phase Tap Changer Tabular</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.PhaseTapChangerTableImpl#getPhaseTapChangerTablePoint <em>Phase Tap Changer Table Point</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PhaseTapChangerTableImpl extends IdentifiedObjectImpl implements PhaseTapChangerTable {
    ...
    public EList< PhaseTapChangerTablePoint > getPhaseTapChangerTablePoint() {
        if( phaseTapChangerTablePoint == null ) {
            phaseTapChangerTablePoint = new EObjectWithInverseResolvingEList.Unsettable< >(
    ...
    public EList< PhaseTapChangerTabular > getPhaseTapChangerTabular() {
        if( phaseTapChangerTabular == null ) {
            phaseTapChangerTabular = new EObjectWithInverseResolvingEList.Unsettable< >(
