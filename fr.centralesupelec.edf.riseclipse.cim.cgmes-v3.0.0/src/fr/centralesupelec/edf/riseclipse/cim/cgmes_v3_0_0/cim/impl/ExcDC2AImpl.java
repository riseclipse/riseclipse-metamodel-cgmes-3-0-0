...
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.ExcDC2A;

/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Exc DC2A</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcDC2AImpl#getEfd2 <em>Efd2</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcDC2AImpl#getEfd1 <em>Efd1</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcDC2AImpl#getTf1 <em>Tf1</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcDC2AImpl#getExclim <em>Exclim</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcDC2AImpl#getSeefd1 <em>Seefd1</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcDC2AImpl#getSeefd2 <em>Seefd2</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcDC2AImpl#getTc <em>Tc</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcDC2AImpl#getTb <em>Tb</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcDC2AImpl#getTa <em>Ta</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcDC2AImpl#getTf <em>Tf</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcDC2AImpl#getTe <em>Te</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcDC2AImpl#getVtlim <em>Vtlim</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcDC2AImpl#getKs <em>Ks</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcDC2AImpl#getKa <em>Ka</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcDC2AImpl#getKf <em>Kf</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcDC2AImpl#getKe <em>Ke</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcDC2AImpl#getVrmax <em>Vrmax</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcDC2AImpl#getVrmin <em>Vrmin</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExcDC2AImpl extends ExcitationSystemDynamicsImpl implements ExcDC2A {
    /**
    ...
    /**
     * The default value of the '{@link #getVtlim() <em>Vtlim</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #getVtlim()
     * @generated
     * @ordered
     */
    protected static final Boolean VTLIM_EDEFAULT = null;

    /**
     * The cached value of the '{@link #getVtlim() <em>Vtlim</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #getVtlim()
     * @generated
     * @ordered
     */
    protected Boolean vtlim = VTLIM_EDEFAULT;

    /**
     * This is true if the Vtlim attribute has been set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     * @ordered
     */
    protected boolean vtlimESet;
    ...
    protected EClass eStaticClass() {
        return CimPackage.eINSTANCE.getExcDC2A();
    }
    ...
    public void setEfd2( Double newEfd2 ) {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_DC2A__EFD2, oldEfd2, efd2,
                    !oldEfd2ESet ) );
    }
    ...
    public void unsetEfd2() {
        ...
        efd2ESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_DC2A__EFD2, oldEfd2, EFD2_EDEFAULT,
                    oldEfd2ESet ) );
    }
    ...
    public void setEfd1( Double newEfd1 ) {
        ...
        efd1ESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_DC2A__EFD1, oldEfd1, efd1,
                    !oldEfd1ESet ) );
    }
    ...
    public void unsetEfd1() {
        ...
        efd1ESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_DC2A__EFD1, oldEfd1, EFD1_EDEFAULT,
                    oldEfd1ESet ) );
    }
    ...
    public void setTf1( Double newTf1 ) {
        ...
        tf1ESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_DC2A__TF1, oldTf1, tf1,
                    !oldTf1ESet ) );
    }
    ...
    public void unsetTf1() {
        ...
        tf1ESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_DC2A__TF1, oldTf1, TF1_EDEFAULT,
                    oldTf1ESet ) );
    }
    ...
    public void setExclim( Boolean newExclim ) {
        ...
        exclimESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_DC2A__EXCLIM, oldExclim, exclim,
                    !oldExclimESet ) );
    }
    ...
    public void unsetExclim() {
        ...
        exclimESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_DC2A__EXCLIM, oldExclim,
    ...
    public void setSeefd1( Double newSeefd1 ) {
        ...
        seefd1ESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_DC2A__SEEFD1, oldSeefd1, seefd1,
                    !oldSeefd1ESet ) );
    }
    ...
    public void unsetSeefd1() {
        ...
        seefd1ESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_DC2A__SEEFD1, oldSeefd1,
    ...
    public void setSeefd2( Double newSeefd2 ) {
        ...
        seefd2ESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_DC2A__SEEFD2, oldSeefd2, seefd2,
                    !oldSeefd2ESet ) );
    }
    ...
    public void unsetSeefd2() {
        ...
        seefd2ESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_DC2A__SEEFD2, oldSeefd2,
    ...
    public void setTc( Double newTc ) {
        ...
        tcESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_DC2A__TC, oldTc, tc, !oldTcESet ) );
    }
    ...
    public void unsetTc() {
        ...
        tcESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_DC2A__TC, oldTc, TC_EDEFAULT,
                    oldTcESet ) );
    }
    ...
    public void setTb( Double newTb ) {
        ...
        tbESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_DC2A__TB, oldTb, tb, !oldTbESet ) );
    }
    ...
    public void unsetTb() {
        ...
        tbESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_DC2A__TB, oldTb, TB_EDEFAULT,
                    oldTbESet ) );
    }
    ...
    public void setTa( Double newTa ) {
        ...
        taESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_DC2A__TA, oldTa, ta, !oldTaESet ) );
    }
    ...
    public void unsetTa() {
        ...
        taESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_DC2A__TA, oldTa, TA_EDEFAULT,
                    oldTaESet ) );
    }
    ...
    public void setTf( Double newTf ) {
        ...
        tfESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_DC2A__TF, oldTf, tf, !oldTfESet ) );
    }
    ...
    public void unsetTf() {
        ...
        tfESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_DC2A__TF, oldTf, TF_EDEFAULT,
                    oldTfESet ) );
    }
    ...
    public void setTe( Double newTe ) {
        ...
        teESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_DC2A__TE, oldTe, te, !oldTeESet ) );
    }
    ...
    public void unsetTe() {
        ...
        teESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_DC2A__TE, oldTe, TE_EDEFAULT,
                    oldTeESet ) );
    }
     ...
     */
    @Override
    public void setVtlim( Boolean newVtlim ) {
        Boolean oldVtlim = vtlim;
        vtlim = newVtlim;
        boolean oldVtlimESet = vtlimESet;
        vtlimESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_DC2A__VTLIM, oldVtlim, vtlim,
                    !oldVtlimESet ) );
    }
     ...
     */
    @Override
    public void unsetVtlim() {
        Boolean oldVtlim = vtlim;
        boolean oldVtlimESet = vtlimESet;
        vtlim = VTLIM_EDEFAULT;
        vtlimESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_DC2A__VTLIM, oldVtlim,
                    VTLIM_EDEFAULT, oldVtlimESet ) );
    }
    ...
    public void setKs( Double newKs ) {
        ...
        ksESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_DC2A__KS, oldKs, ks, !oldKsESet ) );
    }
    ...
    public void unsetKs() {
        ...
        ksESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_DC2A__KS, oldKs, KS_EDEFAULT,
                    oldKsESet ) );
    }
    ...
    public void setKa( Double newKa ) {
        ...
        kaESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_DC2A__KA, oldKa, ka, !oldKaESet ) );
    }
    ...
    public void unsetKa() {
        ...
        kaESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_DC2A__KA, oldKa, KA_EDEFAULT,
                    oldKaESet ) );
    }
    ...
    public void setKf( Double newKf ) {
        ...
        kfESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_DC2A__KF, oldKf, kf, !oldKfESet ) );
    }
    ...
    public void unsetKf() {
        ...
        kfESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_DC2A__KF, oldKf, KF_EDEFAULT,
                    oldKfESet ) );
    }
    ...
    public void setKe( Double newKe ) {
        ...
        keESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_DC2A__KE, oldKe, ke, !oldKeESet ) );
    }
    ...
    public void unsetKe() {
        ...
        keESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_DC2A__KE, oldKe, KE_EDEFAULT,
                    oldKeESet ) );
    }
    ...
    public void setVrmax( Double newVrmax ) {
        ...
        vrmaxESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_DC2A__VRMAX, oldVrmax, vrmax,
                    !oldVrmaxESet ) );
    }
    ...
    public void unsetVrmax() {
        ...
        vrmaxESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_DC2A__VRMAX, oldVrmax,
    ...
    public void setVrmin( Double newVrmin ) {
        ...
        vrminESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_DC2A__VRMIN, oldVrmin, vrmin,
                    !oldVrminESet ) );
    }
    ...
    public void unsetVrmin() {
        ...
        vrminESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_DC2A__VRMIN, oldVrmin,
