 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.NonConformLoadImpl#getLoadGroup <em>Load Group</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NonConformLoadImpl extends EnergyConsumerImpl implements NonConformLoad {
    ...
    public void setLoadGroup( NonConformLoadGroup newLoadGroup ) {
        if( newLoadGroup != loadGroup ) {
            ...
            loadGroupESet = true;
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.NON_CONFORM_LOAD__LOAD_GROUP,
    ...
    public void unsetLoadGroup() {
        if( loadGroup != null ) {
            ...
            loadGroupESet = false;
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.NON_CONFORM_LOAD__LOAD_GROUP, null,
