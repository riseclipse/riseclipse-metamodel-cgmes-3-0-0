 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.AccumulatorLimitSetImpl#getLimits <em>Limits</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.AccumulatorLimitSetImpl#getMeasurements <em>Measurements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AccumulatorLimitSetImpl extends LimitSetImpl implements AccumulatorLimitSet {
    ...
    public EList< AccumulatorLimit > getLimits() {
        if( limits == null ) {
            limits = new EObjectWithInverseResolvingEList.Unsettable< >( AccumulatorLimit.class, this,
    ...
    public EList< Accumulator > getMeasurements() {
        if( measurements == null ) {
            measurements = new EObjectWithInverseEList.Unsettable.ManyInverse< >( Accumulator.class, this,
                    CimPackage.ACCUMULATOR_LIMIT_SET__MEASUREMENTS, CimPackage.ACCUMULATOR__LIMIT_SETS );
        }
        return measurements;
    }
