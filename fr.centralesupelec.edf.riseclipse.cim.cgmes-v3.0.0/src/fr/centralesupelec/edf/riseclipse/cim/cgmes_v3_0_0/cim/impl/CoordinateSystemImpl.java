 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.CoordinateSystemImpl#getCrsUrn <em>Crs Urn</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.CoordinateSystemImpl#getLocations <em>Locations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CoordinateSystemImpl extends IdentifiedObjectImpl implements CoordinateSystem {
    ...
    public EList< Location > getLocations() {
        if( locations == null ) {
            locations = new EObjectWithInverseResolvingEList.Unsettable< >( Location.class, this,
