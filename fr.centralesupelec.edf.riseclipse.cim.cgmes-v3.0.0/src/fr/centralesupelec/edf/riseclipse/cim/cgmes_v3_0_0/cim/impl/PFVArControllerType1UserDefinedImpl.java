...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>PFV Ar Controller Type1 User Defined</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.PFVArControllerType1UserDefinedImpl#getProprietaryParameterDynamics <em>Proprietary Parameter Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.PFVArControllerType1UserDefinedImpl#getProprietary <em>Proprietary</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PFVArControllerType1UserDefinedImpl extends PFVArControllerType1DynamicsImpl
        implements PFVArControllerType1UserDefined {
    /**
     ...
     * @generated
     */
    protected PFVArControllerType1UserDefinedImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return CimPackage.eINSTANCE.getPFVArControllerType1UserDefined();
    }
    ...
    public void setProprietary( Boolean newProprietary ) {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET,
                    CimPackage.PFV_AR_CONTROLLER_TYPE1_USER_DEFINED__PROPRIETARY, oldProprietary, proprietary,
                    !oldProprietaryESet ) );
    }
    ...
    public void unsetProprietary() {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET,
                    CimPackage.PFV_AR_CONTROLLER_TYPE1_USER_DEFINED__PROPRIETARY, oldProprietary, PROPRIETARY_EDEFAULT,
                    oldProprietaryESet ) );
    }
    ...
    public NotificationChain eInverseAdd( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        switch( featureID ) {
        case CimPackage.PFV_AR_CONTROLLER_TYPE1_USER_DEFINED__PROPRIETARY_PARAMETER_DYNAMICS:
...
} //PFVArControllerType1UserDefinedImpl
