 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.EquivalentNetworkImpl#getEquivalentEquipments <em>Equivalent Equipments</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EquivalentNetworkImpl extends ConnectivityNodeContainerImpl implements EquivalentNetwork {
    ...
    public EList< EquivalentEquipment > getEquivalentEquipments() {
        if( equivalentEquipments == null ) {
            equivalentEquipments = new EObjectWithInverseResolvingEList.Unsettable< >(
