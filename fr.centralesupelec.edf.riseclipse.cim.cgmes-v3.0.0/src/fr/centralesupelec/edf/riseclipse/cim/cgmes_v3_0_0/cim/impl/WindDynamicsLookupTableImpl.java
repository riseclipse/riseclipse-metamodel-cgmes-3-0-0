...
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.WindContCurrLimIEC;
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.WindContPType3IEC;
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.WindContQPQULimIEC;
...
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.WindLookupTableFunctionKind;
 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindDynamicsLookupTableImpl#getWindContRotorRIEC <em>Wind Cont Rotor RIEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindDynamicsLookupTableImpl#getLookupTableFunctionType <em>Lookup Table Function Type</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindDynamicsLookupTableImpl#getOutput <em>Output</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindDynamicsLookupTableImpl#getWindContCurrLimIEC <em>Wind Cont Curr Lim IEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindDynamicsLookupTableImpl#getWindPitchContPowerIEC <em>Wind Pitch Cont Power IEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindDynamicsLookupTableImpl#getWindContPType3IEC <em>Wind Cont PType3 IEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindDynamicsLookupTableImpl#getInput <em>Input</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindDynamicsLookupTableImpl#getWindContQPQULimIEC <em>Wind Cont QPQU Lim IEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindDynamicsLookupTableImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindDynamicsLookupTableImpl#getWindPlantReactiveControlIEC <em>Wind Plant Reactive Control IEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindDynamicsLookupTableImpl#getWindProtectionIEC <em>Wind Protection IEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindDynamicsLookupTableImpl#getWindGenType3bIEC <em>Wind Gen Type3b IEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindDynamicsLookupTableImpl#getWindPlantFreqPcontrolIEC <em>Wind Plant Freq Pcontrol IEC</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WindDynamicsLookupTableImpl extends IdentifiedObjectImpl implements WindDynamicsLookupTable {
     ...
     * @ordered
     */
    protected static final WindLookupTableFunctionKind LOOKUP_TABLE_FUNCTION_TYPE_EDEFAULT = WindLookupTableFunctionKind.QWP;
     ...
     * @ordered
     */
    protected static final Double OUTPUT_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double output = OUTPUT_EDEFAULT;
     ...
     * @ordered
     */
    protected static final Double INPUT_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double input = INPUT_EDEFAULT;
    ...
    public void setWindContQPQULimIEC( WindContQPQULimIEC newWindContQPQULimIEC ) {
        if( newWindContQPQULimIEC != windContQPQULimIEC ) {
            ...
            if( newWindContQPQULimIEC != null )
                msgs = ( ( InternalEObject ) newWindContQPQULimIEC ).eInverseAdd( this,
                        CimPackage.WIND_CONT_QPQU_LIM_IEC__WIND_DYNAMICS_LOOKUP_TABLE, WindContQPQULimIEC.class, msgs );
    ...
    public void setWindGenType3bIEC( WindGenType3bIEC newWindGenType3bIEC ) {
        if( newWindGenType3bIEC != windGenType3bIEC ) {
            ...
            if( newWindGenType3bIEC != null )
                msgs = ( ( InternalEObject ) newWindGenType3bIEC ).eInverseAdd( this,
                        CimPackage.WIND_GEN_TYPE3B_IEC__WIND_DYNAMICS_LOOKUP_TABLE, WindGenType3bIEC.class, msgs );
    ...
    public void unsetWindGenType3bIEC() {
        if( windGenType3bIEC != null ) {
            ...
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET,
                        CimPackage.WIND_DYNAMICS_LOOKUP_TABLE__WIND_GEN_TYPE3B_IEC, null, null,
                        oldWindGenType3bIECESet ) );
        }
    }
