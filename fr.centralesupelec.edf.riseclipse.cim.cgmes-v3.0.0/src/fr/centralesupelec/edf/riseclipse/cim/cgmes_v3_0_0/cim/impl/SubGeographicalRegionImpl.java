...
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.DCLine;
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.GeographicalRegion;
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.Line;
 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.SubGeographicalRegionImpl#getLines <em>Lines</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.SubGeographicalRegionImpl#getSubstations <em>Substations</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.SubGeographicalRegionImpl#getDCLines <em>DC Lines</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.SubGeographicalRegionImpl#getRegion <em>Region</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubGeographicalRegionImpl extends IdentifiedObjectImpl implements SubGeographicalRegion {
    ...
    public EList< DCLine > getDCLines() {
        if( dcLines == null ) {
            dcLines = new EObjectWithInverseResolvingEList.Unsettable< >( DCLine.class, this,
    ...
    public EList< Substation > getSubstations() {
        if( substations == null ) {
            substations = new EObjectWithInverseResolvingEList.Unsettable< >( Substation.class, this,
    ...
    public EList< Line > getLines() {
        if( lines == null ) {
            lines = new EObjectWithInverseResolvingEList.Unsettable< >( Line.class, this,
