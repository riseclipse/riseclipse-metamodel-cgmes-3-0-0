 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindAeroConstIECImpl#getWindGenTurbineType1aIEC <em>Wind Gen Turbine Type1a IEC</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WindAeroConstIECImpl extends IdentifiedObjectImpl implements WindAeroConstIEC {
    ...
    public WindGenTurbineType1aIEC getWindGenTurbineType1aIEC() {
        if( windGenTurbineType1aIEC != null && windGenTurbineType1aIEC.eIsProxy() ) {
            InternalEObject oldWindGenTurbineType1aIEC = ( InternalEObject ) windGenTurbineType1aIEC;
            windGenTurbineType1aIEC = ( WindGenTurbineType1aIEC ) eResolveProxy( oldWindGenTurbineType1aIEC );
            if( windGenTurbineType1aIEC != oldWindGenTurbineType1aIEC ) {
     ...
     * @generated
     */
    public WindGenTurbineType1aIEC basicGetWindGenTurbineType1aIEC() {
        return windGenTurbineType1aIEC;
    }
    ...
    public Object eGet( int featureID, boolean resolve, boolean coreType ) {
        switch( featureID ) {
        case CimPackage.WIND_AERO_CONST_IEC__WIND_GEN_TURBINE_TYPE1A_IEC:
            if( resolve ) return getWindGenTurbineType1aIEC();
            return basicGetWindGenTurbineType1aIEC();
        }
