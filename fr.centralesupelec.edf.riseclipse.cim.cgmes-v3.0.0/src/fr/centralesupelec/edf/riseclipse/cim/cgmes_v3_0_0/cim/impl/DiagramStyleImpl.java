 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.DiagramStyleImpl#getDiagram <em>Diagram</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiagramStyleImpl extends IdentifiedObjectImpl implements DiagramStyle {
    ...
    public EList< Diagram > getDiagram() {
        if( diagram == null ) {
            diagram = new EObjectWithInverseResolvingEList.Unsettable< >( Diagram.class, this,
