 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.TopologicalIslandImpl#getAngleRefTopologicalNode <em>Angle Ref Topological Node</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.TopologicalIslandImpl#getTopologicalNodes <em>Topological Nodes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TopologicalIslandImpl extends IdentifiedObjectImpl implements TopologicalIsland {
    ...
    public EList< TopologicalNode > getTopologicalNodes() {
        if( topologicalNodes == null ) {
            topologicalNodes = new EObjectWithInverseEList.Unsettable< >( TopologicalNode.class, this,
                    CimPackage.TOPOLOGICAL_ISLAND__TOPOLOGICAL_NODES, CimPackage.TOPOLOGICAL_NODE__TOPOLOGICAL_ISLAND );
        }
