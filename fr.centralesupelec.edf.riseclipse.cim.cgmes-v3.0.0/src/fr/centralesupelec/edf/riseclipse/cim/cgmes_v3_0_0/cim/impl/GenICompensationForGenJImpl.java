 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.GenICompensationForGenJImpl#getRcij <em>Rcij</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.GenICompensationForGenJImpl#getXcij <em>Xcij</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.GenICompensationForGenJImpl#getVcompIEEEType2 <em>Vcomp IEEE Type2</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.GenICompensationForGenJImpl#getSynchronousMachineDynamics <em>Synchronous Machine Dynamics</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GenICompensationForGenJImpl extends IdentifiedObjectImpl implements GenICompensationForGenJ {
     ...
     * @ordered
     */
    protected static final Double RCIJ_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double rcij = RCIJ_EDEFAULT;
     ...
     * @ordered
     */
    protected static final Double XCIJ_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double xcij = XCIJ_EDEFAULT;
     ...
     */
    @Override
    public void setRcij( Double newRcij ) {
        Double oldRcij = rcij;
        rcij = newRcij;
     ...
     */
    @Override
    public void setXcij( Double newXcij ) {
        Double oldXcij = xcij;
        xcij = newXcij;
    ...
    public void eSet( int featureID, Object newValue ) {
        switch( featureID ) {
        case CimPackage.GEN_ICOMPENSATION_FOR_GEN_J__RCIJ:
            setRcij( ( Double ) newValue );
            return;
        case CimPackage.GEN_ICOMPENSATION_FOR_GEN_J__XCIJ:
            setXcij( ( Double ) newValue );
            return;
        case CimPackage.GEN_ICOMPENSATION_FOR_GEN_J__VCOMP_IEEE_TYPE2:
