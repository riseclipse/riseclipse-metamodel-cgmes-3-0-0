...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>VSC User Defined</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.VSCUserDefinedImpl#getProprietary <em>Proprietary</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.VSCUserDefinedImpl#getProprietaryParameterDynamics <em>Proprietary Parameter Dynamics</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VSCUserDefinedImpl extends VSCDynamicsImpl implements VSCUserDefined {
    /**
    ...
    protected EClass eStaticClass() {
        return CimPackage.eINSTANCE.getVSCUserDefined();
    }
    ...
    public void setProprietary( Boolean newProprietary ) {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.VSC_USER_DEFINED__PROPRIETARY,
    ...
    public void unsetProprietary() {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.VSC_USER_DEFINED__PROPRIETARY,
    ...
    public EList< ProprietaryParameterDynamics > getProprietaryParameterDynamics() {
        if( proprietaryParameterDynamics == null ) {
            proprietaryParameterDynamics = new EObjectWithInverseResolvingEList.Unsettable< >(
                    ...
                    CimPackage.VSC_USER_DEFINED__PROPRIETARY_PARAMETER_DYNAMICS,
                    CimPackage.PROPRIETARY_PARAMETER_DYNAMICS__VSC_USER_DEFINED );
        }
    ...
    public NotificationChain eInverseAdd( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        switch( featureID ) {
        case CimPackage.VSC_USER_DEFINED__PROPRIETARY_PARAMETER_DYNAMICS:
