 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.MeasurementValueSourceImpl#getMeasurementValues <em>Measurement Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeasurementValueSourceImpl extends IdentifiedObjectImpl implements MeasurementValueSource {
    ...
    public EList< MeasurementValue > getMeasurementValues() {
        if( measurementValues == null ) {
            measurementValues = new EObjectWithInverseResolvingEList.Unsettable< >(
