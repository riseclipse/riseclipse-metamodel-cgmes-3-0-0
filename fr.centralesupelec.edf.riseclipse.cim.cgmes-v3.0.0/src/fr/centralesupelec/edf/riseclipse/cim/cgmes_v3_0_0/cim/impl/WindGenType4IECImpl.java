...
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.WindGenType4IEC;
 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindGenType4IECImpl#getDiqmax <em>Diqmax</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindGenType4IECImpl#getDiqmin <em>Diqmin</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindGenType4IECImpl#getWindTurbineType4aIEC <em>Wind Turbine Type4a IEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindGenType4IECImpl#getTg <em>Tg</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindGenType4IECImpl#getDipmax <em>Dipmax</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindGenType4IECImpl#getWindTurbineType4bIEC <em>Wind Turbine Type4b IEC</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WindGenType4IECImpl extends IdentifiedObjectImpl implements WindGenType4IEC {
     ...
     * @ordered
     */
    protected static final Double DIQMIN_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double diqmin = DIQMIN_EDEFAULT;
     ...
     */
    @Override
    public void setDiqmin( Double newDiqmin ) {
        Double oldDiqmin = diqmin;
        diqmin = newDiqmin;
        ...
        if( windTurbineType4aIEC != null ) {
            ...
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET,
                        CimPackage.WIND_GEN_TYPE4_IEC__WIND_TURBINE_TYPE4A_IEC, null, null,
                        oldWindTurbineType4aIECESet ) );
        }
    }
    ...
    public void unsetWindTurbineType4bIEC() {
        if( windTurbineType4bIEC != null ) {
            ...
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET,
                        CimPackage.WIND_GEN_TYPE4_IEC__WIND_TURBINE_TYPE4B_IEC, null, null,
                        oldWindTurbineType4bIECESet ) );
        }
    }
