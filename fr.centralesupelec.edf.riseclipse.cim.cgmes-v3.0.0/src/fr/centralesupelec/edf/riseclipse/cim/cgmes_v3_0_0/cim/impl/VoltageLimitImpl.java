...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Voltage Limit</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.VoltageLimitImpl#getNormalValue <em>Normal Value</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.VoltageLimitImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VoltageLimitImpl extends OperationalLimitImpl implements VoltageLimit {
    /**
    ...
    protected EClass eStaticClass() {
        return CimPackage.eINSTANCE.getVoltageLimit();
    }
    ...
    public void setNormalValue( Double newNormalValue ) {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.VOLTAGE_LIMIT__NORMAL_VALUE,
    ...
    public void unsetNormalValue() {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.VOLTAGE_LIMIT__NORMAL_VALUE,
