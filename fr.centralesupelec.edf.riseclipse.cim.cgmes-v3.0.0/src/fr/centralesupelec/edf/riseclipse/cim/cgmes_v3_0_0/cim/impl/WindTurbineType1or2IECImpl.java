 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindTurbineType1or2IECImpl#getWindProtectionIEC <em>Wind Protection IEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindTurbineType1or2IECImpl#getWindMechIEC <em>Wind Mech IEC</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WindTurbineType1or2IECImpl extends WindTurbineType1or2DynamicsImpl implements WindTurbineType1or2IEC {
        ...
        if( windProtectionIEC != null ) {
            ...
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET,
                        CimPackage.WIND_TURBINE_TYPE1OR2_IEC__WIND_PROTECTION_IEC, null, null,
                        oldWindProtectionIECESet ) );
        }
    }
    ...
    public void setWindMechIEC( WindMechIEC newWindMechIEC ) {
        if( newWindMechIEC != windMechIEC ) {
            ...
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.SET,
                        CimPackage.WIND_TURBINE_TYPE1OR2_IEC__WIND_MECH_IEC, newWindMechIEC, newWindMechIEC,
                        !oldWindMechIECESet ) );
        }
    }
