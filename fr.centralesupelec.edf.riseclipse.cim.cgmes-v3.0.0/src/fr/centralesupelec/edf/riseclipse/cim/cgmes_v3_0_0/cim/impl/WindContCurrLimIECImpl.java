 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindContCurrLimIECImpl#getUpqumax <em>Upqumax</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindContCurrLimIECImpl#getKpqu <em>Kpqu</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindContCurrLimIECImpl#getWindDynamicsLookupTable <em>Wind Dynamics Lookup Table</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindContCurrLimIECImpl#getMqpri <em>Mqpri</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindContCurrLimIECImpl#getWindTurbineType3or4IEC <em>Wind Turbine Type3or4 IEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindContCurrLimIECImpl#getImax <em>Imax</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindContCurrLimIECImpl#getTufiltcl <em>Tufiltcl</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindContCurrLimIECImpl#getMdfslim <em>Mdfslim</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindContCurrLimIECImpl#getImaxdip <em>Imaxdip</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WindContCurrLimIECImpl extends IdentifiedObjectImpl implements WindContCurrLimIEC {
     ...
     * @ordered
     */
    protected static final Double UPQUMAX_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double upqumax = UPQUMAX_EDEFAULT;
     ...
     * @ordered
     */
    protected static final Double KPQU_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double kpqu = KPQU_EDEFAULT;
     ...
     * @ordered
     */
    protected static final Double TUFILTCL_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double tufiltcl = TUFILTCL_EDEFAULT;
     ...
     * @ordered
     */
    protected static final Double IMAXDIP_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double imaxdip = IMAXDIP_EDEFAULT;
     ...
     */
    @Override
    public void setUpqumax( Double newUpqumax ) {
        Double oldUpqumax = upqumax;
        upqumax = newUpqumax;
     ...
     */
    @Override
    public void setKpqu( Double newKpqu ) {
        Double oldKpqu = kpqu;
        kpqu = newKpqu;
     ...
     */
    @Override
    public void setTufiltcl( Double newTufiltcl ) {
        Double oldTufiltcl = tufiltcl;
     ...
     */
    @Override
    public void setImaxdip( Double newImaxdip ) {
        Double oldImaxdip = imaxdip;
        imaxdip = newImaxdip;
    ...
    public void eSet( int featureID, Object newValue ) {
        switch( featureID ) {
        case CimPackage.WIND_CONT_CURR_LIM_IEC__UPQUMAX:
            setUpqumax( ( Double ) newValue );
            return;
        case CimPackage.WIND_CONT_CURR_LIM_IEC__KPQU:
            setKpqu( ( Double ) newValue );
            return;
        case CimPackage.WIND_CONT_CURR_LIM_IEC__WIND_DYNAMICS_LOOKUP_TABLE:
        ...
        case CimPackage.WIND_CONT_CURR_LIM_IEC__IMAX:
            ...
            return;
        case CimPackage.WIND_CONT_CURR_LIM_IEC__TUFILTCL:
            setTufiltcl( ( Double ) newValue );
            return;
        case CimPackage.WIND_CONT_CURR_LIM_IEC__MDFSLIM:
            setMdfslim( ( Boolean ) newValue );
            return;
        case CimPackage.WIND_CONT_CURR_LIM_IEC__IMAXDIP:
            setImaxdip( ( Double ) newValue );
            return;
        }
