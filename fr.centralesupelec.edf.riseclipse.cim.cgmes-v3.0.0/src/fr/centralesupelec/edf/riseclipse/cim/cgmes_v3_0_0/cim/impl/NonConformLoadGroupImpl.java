 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.NonConformLoadGroupImpl#getEnergyConsumers <em>Energy Consumers</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.NonConformLoadGroupImpl#getNonConformLoadSchedules <em>Non Conform Load Schedules</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NonConformLoadGroupImpl extends LoadGroupImpl implements NonConformLoadGroup {
    ...
    public EList< NonConformLoadSchedule > getNonConformLoadSchedules() {
        if( nonConformLoadSchedules == null ) {
            nonConformLoadSchedules = new EObjectWithInverseResolvingEList.Unsettable< >(
    ...
    public EList< NonConformLoad > getEnergyConsumers() {
        if( energyConsumers == null ) {
            energyConsumers = new EObjectWithInverseResolvingEList.Unsettable< >( NonConformLoad.class,
