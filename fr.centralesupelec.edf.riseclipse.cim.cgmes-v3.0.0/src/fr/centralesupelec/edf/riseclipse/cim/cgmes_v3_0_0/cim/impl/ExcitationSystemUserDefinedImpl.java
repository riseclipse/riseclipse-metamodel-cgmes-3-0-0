...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Excitation System User Defined</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcitationSystemUserDefinedImpl#getProprietaryParameterDynamics <em>Proprietary Parameter Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcitationSystemUserDefinedImpl#getProprietary <em>Proprietary</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExcitationSystemUserDefinedImpl extends ExcitationSystemDynamicsImpl
        implements ExcitationSystemUserDefined {
    /**
     ...
     * @generated
     */
    protected ExcitationSystemUserDefinedImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return CimPackage.eINSTANCE.getExcitationSystemUserDefined();
    }
    ...
    public void setProprietary( Boolean newProprietary ) {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET,
                    CimPackage.EXCITATION_SYSTEM_USER_DEFINED__PROPRIETARY, oldProprietary, proprietary,
                    !oldProprietaryESet ) );
    }
    ...
    public void unsetProprietary() {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET,
                    CimPackage.EXCITATION_SYSTEM_USER_DEFINED__PROPRIETARY, oldProprietary, PROPRIETARY_EDEFAULT,
                    oldProprietaryESet ) );
    }
    ...
    public NotificationChain eInverseAdd( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        switch( featureID ) {
        case CimPackage.EXCITATION_SYSTEM_USER_DEFINED__PROPRIETARY_PARAMETER_DYNAMICS:
...
} //ExcitationSystemUserDefinedImpl
