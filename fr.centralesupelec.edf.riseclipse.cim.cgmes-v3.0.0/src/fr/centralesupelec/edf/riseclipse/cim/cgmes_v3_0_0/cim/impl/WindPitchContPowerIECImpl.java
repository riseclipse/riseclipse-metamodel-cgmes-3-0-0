...
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.WindGenTurbineType1bIEC;
 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindPitchContPowerIECImpl#getPset <em>Pset</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindPitchContPowerIECImpl#getWindDynamicsLookupTable <em>Wind Dynamics Lookup Table</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindPitchContPowerIECImpl#getDpmax <em>Dpmax</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindPitchContPowerIECImpl#getDpmin <em>Dpmin</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindPitchContPowerIECImpl#getWindGenTurbineType2IEC <em>Wind Gen Turbine Type2 IEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindPitchContPowerIECImpl#getUuvrt <em>Uuvrt</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindPitchContPowerIECImpl#getWindGenTurbineType1bIEC <em>Wind Gen Turbine Type1b IEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindPitchContPowerIECImpl#getTr <em>Tr</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindPitchContPowerIECImpl#getT1 <em>T1</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindPitchContPowerIECImpl#getPmin <em>Pmin</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WindPitchContPowerIECImpl extends IdentifiedObjectImpl implements WindPitchContPowerIEC {
     ...
     * @ordered
     */
    protected static final Double PSET_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double pset = PSET_EDEFAULT;
     ...
     * @ordered
     */
    protected static final Double DPMIN_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double dpmin = DPMIN_EDEFAULT;
     ...
     * @ordered
     */
    protected static final Double UUVRT_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double uuvrt = UUVRT_EDEFAULT;
     ...
     */
    @Override
    public void setPset( Double newPset ) {
        Double oldPset = pset;
        pset = newPset;
     ...
     */
    @Override
    public void setDpmin( Double newDpmin ) {
        Double oldDpmin = dpmin;
        dpmin = newDpmin;
     ...
     */
    @Override
    public void setUuvrt( Double newUuvrt ) {
        Double oldUuvrt = uuvrt;
        uuvrt = newUuvrt;
    ...
    public WindGenTurbineType1bIEC getWindGenTurbineType1bIEC() {
        if( windGenTurbineType1bIEC != null && windGenTurbineType1bIEC.eIsProxy() ) {
     ...
     * @generated
     */
    public WindGenTurbineType1bIEC basicGetWindGenTurbineType1bIEC() {
        return windGenTurbineType1bIEC;
    }
