 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.SubstationImpl#getRegion <em>Region</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.SubstationImpl#getVoltageLevels <em>Voltage Levels</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.SubstationImpl#getDCConverterUnit <em>DC Converter Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubstationImpl extends EquipmentContainerImpl implements Substation {
    ...
    public EList< VoltageLevel > getVoltageLevels() {
        if( voltageLevels == null ) {
            voltageLevels = new EObjectWithInverseResolvingEList.Unsettable< >( VoltageLevel.class, this,
    ...
    public EList< DCConverterUnit > getDCConverterUnit() {
        if( dcConverterUnit == null ) {
            dcConverterUnit = new EObjectWithInverseResolvingEList.Unsettable< >( DCConverterUnit.class,
