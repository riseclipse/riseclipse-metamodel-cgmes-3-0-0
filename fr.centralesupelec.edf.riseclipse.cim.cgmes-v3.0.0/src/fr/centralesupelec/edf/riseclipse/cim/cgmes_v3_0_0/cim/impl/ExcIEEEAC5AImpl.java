...
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.ExcIEEEAC5A;
 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcIEEEAC5AImpl#getEfd2 <em>Efd2</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcIEEEAC5AImpl#getEfd1 <em>Efd1</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcIEEEAC5AImpl#getTe <em>Te</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcIEEEAC5AImpl#getTa <em>Ta</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcIEEEAC5AImpl#getTf3 <em>Tf3</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcIEEEAC5AImpl#getTf2 <em>Tf2</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcIEEEAC5AImpl#getTf1 <em>Tf1</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcIEEEAC5AImpl#getSeefd2 <em>Seefd2</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcIEEEAC5AImpl#getSeefd1 <em>Seefd1</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcIEEEAC5AImpl#getKa <em>Ka</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcIEEEAC5AImpl#getKe <em>Ke</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcIEEEAC5AImpl#getKf <em>Kf</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcIEEEAC5AImpl#getVrmax <em>Vrmax</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ExcIEEEAC5AImpl#getVrmin <em>Vrmin</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExcIEEEAC5AImpl extends ExcitationSystemDynamicsImpl implements ExcIEEEAC5A {
     ...
     * @ordered
     */
    protected static final Double TF3_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double tf3 = TF3_EDEFAULT;
    ...
    public void setEfd2( Double newEfd2 ) {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_IEEEAC5A__EFD2, oldEfd2, efd2,
                    !oldEfd2ESet ) );
    }
    ...
    public void unsetEfd2() {
        ...
        efd2ESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_IEEEAC5A__EFD2, oldEfd2,
    ...
    public void setEfd1( Double newEfd1 ) {
        ...
        efd1ESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_IEEEAC5A__EFD1, oldEfd1, efd1,
                    !oldEfd1ESet ) );
    }
    ...
    public void unsetEfd1() {
        ...
        efd1ESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_IEEEAC5A__EFD1, oldEfd1,
    ...
    public void setTe( Double newTe ) {
        ...
        teESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_IEEEAC5A__TE, oldTe, te,
                    !oldTeESet ) );
    }
    ...
    public void unsetTe() {
        ...
        teESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_IEEEAC5A__TE, oldTe, TE_EDEFAULT,
                    oldTeESet ) );
    }
    ...
    public void setTa( Double newTa ) {
        ...
        taESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_IEEEAC5A__TA, oldTa, ta,
                    !oldTaESet ) );
    }
    ...
    public void unsetTa() {
        ...
        taESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_IEEEAC5A__TA, oldTa, TA_EDEFAULT,
                    oldTaESet ) );
    }
     ...
     */
    @Override
    public void setTf3( Double newTf3 ) {
        Double oldTf3 = tf3;
        tf3 = newTf3;
        boolean oldTf3ESet = tf3ESet;
        tf3ESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_IEEEAC5A__TF3, oldTf3, tf3,
                    !oldTf3ESet ) );
    }
    ...
    public void unsetTf3() {
        ...
        tf3ESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_IEEEAC5A__TF3, oldTf3,
                    TF3_EDEFAULT, oldTf3ESet ) );
    }
    ...
    public void setTf2( Double newTf2 ) {
        ...
        tf2ESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_IEEEAC5A__TF2, oldTf2, tf2,
                    !oldTf2ESet ) );
    }
    ...
    public void unsetTf2() {
        ...
        tf2ESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_IEEEAC5A__TF2, oldTf2,
    ...
    public void setTf1( Double newTf1 ) {
        ...
        tf1ESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_IEEEAC5A__TF1, oldTf1, tf1,
                    !oldTf1ESet ) );
    }
    ...
    public void unsetTf1() {
        ...
        tf1ESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_IEEEAC5A__TF1, oldTf1,
    ...
    public void setSeefd2( Double newSeefd2 ) {
        ...
        seefd2ESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_IEEEAC5A__SEEFD2, oldSeefd2, seefd2,
                    !oldSeefd2ESet ) );
    }
    ...
    public void unsetSeefd2() {
        ...
        seefd2ESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_IEEEAC5A__SEEFD2, oldSeefd2,
    ...
    public void setSeefd1( Double newSeefd1 ) {
        ...
        seefd1ESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_IEEEAC5A__SEEFD1, oldSeefd1, seefd1,
                    !oldSeefd1ESet ) );
    }
    ...
    public void unsetSeefd1() {
        ...
        seefd1ESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_IEEEAC5A__SEEFD1, oldSeefd1,
    ...
    public void setKa( Double newKa ) {
        ...
        kaESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_IEEEAC5A__KA, oldKa, ka,
                    !oldKaESet ) );
    }
    ...
    public void unsetKa() {
        ...
        kaESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_IEEEAC5A__KA, oldKa, KA_EDEFAULT,
                    oldKaESet ) );
    }
    ...
    public void setKe( Double newKe ) {
        ...
        keESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_IEEEAC5A__KE, oldKe, ke,
                    !oldKeESet ) );
    }
    ...
    public void unsetKe() {
        ...
        keESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_IEEEAC5A__KE, oldKe, KE_EDEFAULT,
                    oldKeESet ) );
    }
    ...
    public void setKf( Double newKf ) {
        ...
        kfESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_IEEEAC5A__KF, oldKf, kf,
                    !oldKfESet ) );
    }
    ...
    public void unsetKf() {
        ...
        kfESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_IEEEAC5A__KF, oldKf, KF_EDEFAULT,
                    oldKfESet ) );
    }
    ...
    public void setVrmax( Double newVrmax ) {
        ...
        vrmaxESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_IEEEAC5A__VRMAX, oldVrmax, vrmax,
                    !oldVrmaxESet ) );
    }
    ...
    public void unsetVrmax() {
        ...
        vrmaxESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_IEEEAC5A__VRMAX, oldVrmax,
    ...
    public void setVrmin( Double newVrmin ) {
        ...
        vrminESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.EXC_IEEEAC5A__VRMIN, oldVrmin, vrmin,
                    !oldVrminESet ) );
    }
    ...
    public void unsetVrmin() {
        ...
        vrminESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.EXC_IEEEAC5A__VRMIN, oldVrmin,
