...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Turbine Governor User Defined</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.TurbineGovernorUserDefinedImpl#getProprietaryParameterDynamics <em>Proprietary Parameter Dynamics</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.TurbineGovernorUserDefinedImpl#getProprietary <em>Proprietary</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TurbineGovernorUserDefinedImpl extends TurbineGovernorDynamicsImpl implements TurbineGovernorUserDefined {
    /**
     ...
     * @generated
     */
    protected TurbineGovernorUserDefinedImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return CimPackage.eINSTANCE.getTurbineGovernorUserDefined();
    }
    ...
    public void setProprietary( Boolean newProprietary ) {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET,
                    CimPackage.TURBINE_GOVERNOR_USER_DEFINED__PROPRIETARY, oldProprietary, proprietary,
                    !oldProprietaryESet ) );
    }
    ...
    public void unsetProprietary() {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET,
                    CimPackage.TURBINE_GOVERNOR_USER_DEFINED__PROPRIETARY, oldProprietary, PROPRIETARY_EDEFAULT,
                    oldProprietaryESet ) );
    }
    ...
    public NotificationChain eInverseAdd( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        switch( featureID ) {
        case CimPackage.TURBINE_GOVERNOR_USER_DEFINED__PROPRIETARY_PARAMETER_DYNAMICS:
    ...
    public Object eGet( int featureID, boolean resolve, boolean coreType ) {
        ...
        case CimPackage.TURBINE_GOVERNOR_USER_DEFINED__PROPRIETARY:
...
} //TurbineGovernorUserDefinedImpl
