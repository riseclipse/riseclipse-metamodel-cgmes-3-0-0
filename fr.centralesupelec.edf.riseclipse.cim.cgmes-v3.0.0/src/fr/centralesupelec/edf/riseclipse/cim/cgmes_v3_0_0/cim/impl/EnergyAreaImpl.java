 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.EnergyAreaImpl#getControlArea <em>Control Area</em>}</li>
 * </ul>
 *
 * @generated
 */
        ...
        if( controlArea != null && controlArea.eIsProxy() ) {
            ...
            if( controlArea != oldControlArea ) {
                if( eNotificationRequired() )
                    eNotify( new ENotificationImpl( this, Notification.RESOLVE, CimPackage.ENERGY_AREA__CONTROL_AREA,
                            oldControlArea, controlArea ) );
            }
        }
        return controlArea;
    }
