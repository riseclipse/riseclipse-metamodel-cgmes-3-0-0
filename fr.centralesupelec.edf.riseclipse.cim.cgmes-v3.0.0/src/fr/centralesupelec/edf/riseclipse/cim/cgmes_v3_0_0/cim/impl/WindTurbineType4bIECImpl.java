 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindTurbineType4bIECImpl#getWindContPType4bIEC <em>Wind Cont PType4b IEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindTurbineType4bIECImpl#getWindMechIEC <em>Wind Mech IEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindTurbineType4bIECImpl#getWindGenType4IEC <em>Wind Gen Type4 IEC</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WindTurbineType4bIECImpl extends WindTurbineType4IECImpl implements WindTurbineType4bIEC {
    ...
    public void setWindContPType4bIEC( WindContPType4bIEC newWindContPType4bIEC ) {
        if( newWindContPType4bIEC != windContPType4bIEC ) {
            ...
            if( newWindContPType4bIEC != null )
                msgs = ( ( InternalEObject ) newWindContPType4bIEC ).eInverseAdd( this,
                        CimPackage.WIND_CONT_PTYPE4B_IEC__WIND_TURBINE_TYPE4B_IEC, WindContPType4bIEC.class, msgs );
    ...
    public void setWindMechIEC( WindMechIEC newWindMechIEC ) {
        if( newWindMechIEC != windMechIEC ) {
            ...
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.SET,
                        CimPackage.WIND_TURBINE_TYPE4B_IEC__WIND_MECH_IEC, newWindMechIEC, newWindMechIEC,
                        !oldWindMechIECESet ) );
        }
    }
    ...
    public void setWindGenType4IEC( WindGenType4IEC newWindGenType4IEC ) {
        if( newWindGenType4IEC != windGenType4IEC ) {
            ...
            if( newWindGenType4IEC != null )
                msgs = ( ( InternalEObject ) newWindGenType4IEC ).eInverseAdd( this,
                        CimPackage.WIND_GEN_TYPE4_IEC__WIND_TURBINE_TYPE4B_IEC, WindGenType4IEC.class, msgs );
