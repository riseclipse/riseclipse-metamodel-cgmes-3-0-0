...
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.WindRefFrameRotIEC;
 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindRefFrameRotIECImpl#getTpll <em>Tpll</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindRefFrameRotIECImpl#getUpll1 <em>Upll1</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindRefFrameRotIECImpl#getUpll2 <em>Upll2</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindRefFrameRotIECImpl#getWindTurbineType3or4IEC <em>Wind Turbine Type3or4 IEC</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WindRefFrameRotIECImpl extends IdentifiedObjectImpl implements WindRefFrameRotIEC {
     ...
     * @ordered
     */
    protected static final Double TPLL_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double tpll = TPLL_EDEFAULT;
     ...
     * @ordered
     */
    protected static final Double UPLL1_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double upll1 = UPLL1_EDEFAULT;
     ...
     * @ordered
     */
    protected static final Double UPLL2_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double upll2 = UPLL2_EDEFAULT;
     ...
     */
    @Override
    public void setTpll( Double newTpll ) {
        Double oldTpll = tpll;
        tpll = newTpll;
        boolean oldTpllESet = tpllESet;
        tpllESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.WIND_REF_FRAME_ROT_IEC__TPLL, oldTpll,
                    tpll, !oldTpllESet ) );
    }
    ...
    public void unsetTpll() {
        ...
        tpllESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.WIND_REF_FRAME_ROT_IEC__TPLL, oldTpll,
                    TPLL_EDEFAULT, oldTpllESet ) );
    }
     ...
     */
    @Override
    public void setUpll1( Double newUpll1 ) {
        Double oldUpll1 = upll1;
        upll1 = newUpll1;
        boolean oldUpll1ESet = upll1ESet;
        upll1ESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.WIND_REF_FRAME_ROT_IEC__UPLL1, oldUpll1,
                    upll1, !oldUpll1ESet ) );
    }
    ...
    public void unsetUpll1() {
        ...
        upll1ESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.WIND_REF_FRAME_ROT_IEC__UPLL1,
                    oldUpll1, UPLL1_EDEFAULT, oldUpll1ESet ) );
    }
     ...
     */
    @Override
    public void setUpll2( Double newUpll2 ) {
        Double oldUpll2 = upll2;
        upll2 = newUpll2;
        boolean oldUpll2ESet = upll2ESet;
        upll2ESet = true;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.WIND_REF_FRAME_ROT_IEC__UPLL2, oldUpll2,
                    upll2, !oldUpll2ESet ) );
    }
    ...
    public void unsetUpll2() {
        ...
        upll2ESet = false;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.WIND_REF_FRAME_ROT_IEC__UPLL2,
                    oldUpll2, UPLL2_EDEFAULT, oldUpll2ESet ) );
    }
    ...
    public void eSet( int featureID, Object newValue ) {
        switch( featureID ) {
        case CimPackage.WIND_REF_FRAME_ROT_IEC__TPLL:
            setTpll( ( Double ) newValue );
            return;
        case CimPackage.WIND_REF_FRAME_ROT_IEC__UPLL1:
            setUpll1( ( Double ) newValue );
            return;
        case CimPackage.WIND_REF_FRAME_ROT_IEC__UPLL2:
            setUpll2( ( Double ) newValue );
            return;
        case CimPackage.WIND_REF_FRAME_ROT_IEC__WIND_TURBINE_TYPE3OR4_IEC:
