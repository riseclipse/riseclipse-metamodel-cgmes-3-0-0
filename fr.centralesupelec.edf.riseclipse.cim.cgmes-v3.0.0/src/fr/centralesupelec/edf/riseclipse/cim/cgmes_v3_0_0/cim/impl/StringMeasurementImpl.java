 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.StringMeasurementImpl#getStringMeasurementValues <em>String Measurement Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringMeasurementImpl extends MeasurementImpl implements StringMeasurement {
    ...
    public EList< StringMeasurementValue > getStringMeasurementValues() {
        if( stringMeasurementValues == null ) {
            stringMeasurementValues = new EObjectWithInverseResolvingEList.Unsettable< >(
