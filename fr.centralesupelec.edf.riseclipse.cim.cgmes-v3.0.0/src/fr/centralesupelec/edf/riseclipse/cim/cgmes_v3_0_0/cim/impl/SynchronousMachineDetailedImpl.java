...
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.IfdBaseKind;
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.SynchronousMachineDetailed;
 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.SynchronousMachineDetailedImpl#getIfdBaseType <em>Ifd Base Type</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.SynchronousMachineDetailedImpl#getEfdBaseRatio <em>Efd Base Ratio</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.SynchronousMachineDetailedImpl#getSaturationFactor120QAxis <em>Saturation Factor120 QAxis</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.SynchronousMachineDetailedImpl#getSaturationFactorQAxis <em>Saturation Factor QAxis</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SynchronousMachineDetailedImpl extends SynchronousMachineDynamicsImpl
     ...
     * @ordered
     */
    protected static final IfdBaseKind IFD_BASE_TYPE_EDEFAULT = IfdBaseKind.IFNL;
     ...
     * @ordered
     */
    protected static final Double EFD_BASE_RATIO_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double efdBaseRatio = EFD_BASE_RATIO_EDEFAULT;
     ...
     * @ordered
     */
    protected static final Double SATURATION_FACTOR120_QAXIS_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double saturationFactor120QAxis = SATURATION_FACTOR120_QAXIS_EDEFAULT;
     ...
     * @ordered
     */
    protected static final Double SATURATION_FACTOR_QAXIS_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double saturationFactorQAxis = SATURATION_FACTOR_QAXIS_EDEFAULT;
     ...
     */
    @Override
    public void setEfdBaseRatio( Double newEfdBaseRatio ) {
        Double oldEfdBaseRatio = efdBaseRatio;
     ...
     */
    @Override
    public void setSaturationFactor120QAxis( Double newSaturationFactor120QAxis ) {
        Double oldSaturationFactor120QAxis = saturationFactor120QAxis;
     ...
     */
    @Override
    public void setSaturationFactorQAxis( Double newSaturationFactorQAxis ) {
        Double oldSaturationFactorQAxis = saturationFactorQAxis;
    ...
    public void eSet( int featureID, Object newValue ) {
        ...
        case CimPackage.SYNCHRONOUS_MACHINE_DETAILED__IFD_BASE_TYPE:
            ...
            return;
        case CimPackage.SYNCHRONOUS_MACHINE_DETAILED__EFD_BASE_RATIO:
            setEfdBaseRatio( ( Double ) newValue );
            return;
        case CimPackage.SYNCHRONOUS_MACHINE_DETAILED__SATURATION_FACTOR120_QAXIS:
            setSaturationFactor120QAxis( ( Double ) newValue );
            return;
        case CimPackage.SYNCHRONOUS_MACHINE_DETAILED__SATURATION_FACTOR_QAXIS:
            setSaturationFactorQAxis( ( Double ) newValue );
            return;
        }
