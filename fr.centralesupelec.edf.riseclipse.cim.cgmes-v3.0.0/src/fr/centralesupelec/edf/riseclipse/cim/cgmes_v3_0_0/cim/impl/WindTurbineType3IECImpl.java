 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindTurbineType3IECImpl#getWindAeroTwoDimIEC <em>Wind Aero Two Dim IEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindTurbineType3IECImpl#getWindGenType3IEC <em>Wind Gen Type3 IEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindTurbineType3IECImpl#getWindContPitchAngleIEC <em>Wind Cont Pitch Angle IEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindTurbineType3IECImpl#getWindMechIEC <em>Wind Mech IEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindTurbineType3IECImpl#getWindContPType3IEC <em>Wind Cont PType3 IEC</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.WindTurbineType3IECImpl#getWindAeroOneDimIEC <em>Wind Aero One Dim IEC</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WindTurbineType3IECImpl extends WindTurbineType3or4IECImpl implements WindTurbineType3IEC {
    ...
    public void setWindAeroTwoDimIEC( WindAeroTwoDimIEC newWindAeroTwoDimIEC ) {
        if( newWindAeroTwoDimIEC != windAeroTwoDimIEC ) {
            ...
            if( newWindAeroTwoDimIEC != null )
                msgs = ( ( InternalEObject ) newWindAeroTwoDimIEC ).eInverseAdd( this,
                        CimPackage.WIND_AERO_TWO_DIM_IEC__WIND_TURBINE_TYPE3_IEC, WindAeroTwoDimIEC.class, msgs );
        ...
        if( windAeroTwoDimIEC != null ) {
            ...
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET,
                        CimPackage.WIND_TURBINE_TYPE3_IEC__WIND_AERO_TWO_DIM_IEC, null, null,
                        oldWindAeroTwoDimIECESet ) );
        }
    }
    ...
    public void setWindGenType3IEC( WindGenType3IEC newWindGenType3IEC ) {
        if( newWindGenType3IEC != windGenType3IEC ) {
            ...
            if( newWindGenType3IEC != null )
                msgs = ( ( InternalEObject ) newWindGenType3IEC ).eInverseAdd( this,
                        CimPackage.WIND_GEN_TYPE3_IEC__WIND_TURBINE_TYPE3_IEC, WindGenType3IEC.class, msgs );
    ...
    public void setWindMechIEC( WindMechIEC newWindMechIEC ) {
        if( newWindMechIEC != windMechIEC ) {
            ...
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.SET,
                        CimPackage.WIND_TURBINE_TYPE3_IEC__WIND_MECH_IEC, newWindMechIEC, newWindMechIEC,
                        !oldWindMechIECESet ) );
        }
    }
    ...
    public void setWindContPType3IEC( WindContPType3IEC newWindContPType3IEC ) {
        if( newWindContPType3IEC != windContPType3IEC ) {
            ...
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.SET,
                        CimPackage.WIND_TURBINE_TYPE3_IEC__WIND_CONT_PTYPE3_IEC, newWindContPType3IEC,
    ...
    public void unsetWindContPType3IEC() {
        if( windContPType3IEC != null ) {
            ...
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET,
                        CimPackage.WIND_TURBINE_TYPE3_IEC__WIND_CONT_PTYPE3_IEC, null, null,
                        oldWindContPType3IECESet ) );
        }
    }
    ...
    public void setWindAeroOneDimIEC( WindAeroOneDimIEC newWindAeroOneDimIEC ) {
        if( newWindAeroOneDimIEC != windAeroOneDimIEC ) {
            ...
            if( newWindAeroOneDimIEC != null )
                msgs = ( ( InternalEObject ) newWindAeroOneDimIEC ).eInverseAdd( this,
                        CimPackage.WIND_AERO_ONE_DIM_IEC__WIND_TURBINE_TYPE3_IEC, WindAeroOneDimIEC.class, msgs );
    ...
    public void unsetWindAeroOneDimIEC() {
        if( windAeroOneDimIEC != null ) {
            ...
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET,
                        CimPackage.WIND_TURBINE_TYPE3_IEC__WIND_AERO_ONE_DIM_IEC, null, null,
                        oldWindAeroOneDimIECESet ) );
        }
    }
    ...
    public Object eGet( int featureID, boolean resolve, boolean coreType ) {
        switch( featureID ) {
        case CimPackage.WIND_TURBINE_TYPE3_IEC__WIND_AERO_TWO_DIM_IEC:
            return getWindAeroTwoDimIEC();
        case CimPackage.WIND_TURBINE_TYPE3_IEC__WIND_GEN_TYPE3_IEC:
            return getWindGenType3IEC();
        case CimPackage.WIND_TURBINE_TYPE3_IEC__WIND_CONT_PITCH_ANGLE_IEC:
