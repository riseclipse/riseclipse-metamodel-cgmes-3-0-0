...
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.ControlAreaTypeKind;
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.EnergyArea;
 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ControlAreaImpl#getControlAreaGeneratingUnit <em>Control Area Generating Unit</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ControlAreaImpl#getTieFlow <em>Tie Flow</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ControlAreaImpl#getType <em>Type</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ControlAreaImpl#getEnergyArea <em>Energy Area</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ControlAreaImpl#getPTolerance <em>PTolerance</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ControlAreaImpl#getNetInterchange <em>Net Interchange</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ControlAreaImpl extends PowerSystemResourceImpl implements ControlArea {
     ...
     * @ordered
     */
    protected static final Double PTOLERANCE_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double pTolerance = PTOLERANCE_EDEFAULT;
     ...
     * @ordered
     */
    protected static final Double NET_INTERCHANGE_EDEFAULT = null;
    ...
    public void unsetTieFlow() {
        if( tieFlow != null ) {
            ( ( InternalEList.Unsettable< ? > ) tieFlow ).unset();
        }
    }
     ...
     */
    @Override
    public void setPTolerance( Double newPTolerance ) {
        Double oldPTolerance = pTolerance;
