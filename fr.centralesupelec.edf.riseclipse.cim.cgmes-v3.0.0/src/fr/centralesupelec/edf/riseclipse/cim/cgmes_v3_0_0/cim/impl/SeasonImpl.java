...
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.Season;
 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.SeasonImpl#getEndDate <em>End Date</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.SeasonImpl#getStartDate <em>Start Date</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.SeasonImpl#getSeasonDayTypeSchedules <em>Season Day Type Schedules</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SeasonImpl extends IdentifiedObjectImpl implements Season {
    ...
    public EList< SeasonDayTypeSchedule > getSeasonDayTypeSchedules() {
        if( seasonDayTypeSchedules == null ) {
            seasonDayTypeSchedules = new EObjectWithInverseResolvingEList.Unsettable< >(
