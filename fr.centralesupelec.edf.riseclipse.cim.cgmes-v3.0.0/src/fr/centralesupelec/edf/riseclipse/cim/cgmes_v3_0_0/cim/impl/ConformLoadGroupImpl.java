 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ConformLoadGroupImpl#getConformLoadSchedules <em>Conform Load Schedules</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.ConformLoadGroupImpl#getEnergyConsumers <em>Energy Consumers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConformLoadGroupImpl extends LoadGroupImpl implements ConformLoadGroup {
    ...
    public EList< ConformLoadSchedule > getConformLoadSchedules() {
        if( conformLoadSchedules == null ) {
            conformLoadSchedules = new EObjectWithInverseResolvingEList.Unsettable< >(
    ...
    public EList< ConformLoad > getEnergyConsumers() {
        if( energyConsumers == null ) {
            energyConsumers = new EObjectWithInverseResolvingEList.Unsettable< >( ConformLoad.class, this,
