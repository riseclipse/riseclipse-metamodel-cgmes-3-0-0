 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.RatioTapChangerTableImpl#getRatioTapChanger <em>Ratio Tap Changer</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.RatioTapChangerTableImpl#getRatioTapChangerTablePoint <em>Ratio Tap Changer Table Point</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RatioTapChangerTableImpl extends IdentifiedObjectImpl implements RatioTapChangerTable {
    ...
    public EList< RatioTapChangerTablePoint > getRatioTapChangerTablePoint() {
        if( ratioTapChangerTablePoint == null ) {
            ratioTapChangerTablePoint = new EObjectWithInverseResolvingEList.Unsettable< >(
    ...
    public EList< RatioTapChanger > getRatioTapChanger() {
        if( ratioTapChanger == null ) {
            ratioTapChanger = new EObjectWithInverseResolvingEList.Unsettable< >( RatioTapChanger.class,
