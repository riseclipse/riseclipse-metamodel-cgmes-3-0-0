...
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.PFVArType1IEEEVArController;
 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.PFVArType1IEEEVArControllerImpl#getTvarc <em>Tvarc</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.PFVArType1IEEEVArControllerImpl#getVvar <em>Vvar</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.PFVArType1IEEEVArControllerImpl#getVvarcbw <em>Vvarcbw</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.PFVArType1IEEEVArControllerImpl#getVvtmax <em>Vvtmax</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.PFVArType1IEEEVArControllerImpl#getVvtmin <em>Vvtmin</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.PFVArType1IEEEVArControllerImpl#getVvarref <em>Vvarref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PFVArType1IEEEVArControllerImpl extends PFVArControllerType1DynamicsImpl
     ...
     * @ordered
     */
    protected static final Double TVARC_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double tvarc = TVARC_EDEFAULT;
     ...
     * @ordered
     */
    protected static final Double VVAR_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double vvar = VVAR_EDEFAULT;
     ...
     * @ordered
     */
    protected static final Double VVARCBW_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double vvarcbw = VVARCBW_EDEFAULT;
     ...
     * @ordered
     */
    protected static final Double VVARREF_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Double vvarref = VVARREF_EDEFAULT;
     ...
     */
    @Override
    public void setTvarc( Double newTvarc ) {
        Double oldTvarc = tvarc;
        tvarc = newTvarc;
     ...
     */
    @Override
    public void setVvar( Double newVvar ) {
        Double oldVvar = vvar;
        vvar = newVvar;
     ...
     */
    @Override
    public void setVvarcbw( Double newVvarcbw ) {
        Double oldVvarcbw = vvarcbw;
        vvarcbw = newVvarcbw;
     ...
     */
    @Override
    public void setVvarref( Double newVvarref ) {
        Double oldVvarref = vvarref;
        vvarref = newVvarref;
    ...
    public void eSet( int featureID, Object newValue ) {
        switch( featureID ) {
        case CimPackage.PFV_AR_TYPE1_IEEEV_AR_CONTROLLER__TVARC:
            setTvarc( ( Double ) newValue );
            return;
        case CimPackage.PFV_AR_TYPE1_IEEEV_AR_CONTROLLER__VVAR:
            setVvar( ( Double ) newValue );
            return;
        case CimPackage.PFV_AR_TYPE1_IEEEV_AR_CONTROLLER__VVARCBW:
            setVvarcbw( ( Double ) newValue );
            return;
        case CimPackage.PFV_AR_TYPE1_IEEEV_AR_CONTROLLER__VVTMAX:
