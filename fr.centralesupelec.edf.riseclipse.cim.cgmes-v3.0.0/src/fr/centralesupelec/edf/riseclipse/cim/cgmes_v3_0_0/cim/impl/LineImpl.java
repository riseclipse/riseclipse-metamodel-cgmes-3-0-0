 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.impl.LineImpl#getRegion <em>Region</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LineImpl extends EquipmentContainerImpl implements Line {
    ...
    protected EClass eStaticClass() {
        return CimPackage.eINSTANCE.getLine();
    }
    ...
    public NotificationChain basicSetRegion( SubGeographicalRegion newRegion, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET, CimPackage.LINE__REGION,
    ...
    public void setRegion( SubGeographicalRegion newRegion ) {
        if( newRegion != region ) {
            ...
            if( region != null )
                msgs = ( ( InternalEObject ) region ).eInverseRemove( this, CimPackage.SUB_GEOGRAPHICAL_REGION__LINES,
                        SubGeographicalRegion.class, msgs );
            if( newRegion != null )
                msgs = ( ( InternalEObject ) newRegion ).eInverseAdd( this, CimPackage.SUB_GEOGRAPHICAL_REGION__LINES,
                        SubGeographicalRegion.class, msgs );
            ...
            regionESet = true;
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.SET, CimPackage.LINE__REGION, newRegion, newRegion,
                        !oldRegionESet ) );
        }
    }
    ...
    public NotificationChain basicUnsetRegion( NotificationChain msgs ) {
        ...
        regionESet = false;
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.UNSET, CimPackage.LINE__REGION,
                    oldRegion, null, oldRegionESet );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
    ...
    public void unsetRegion() {
        if( region != null ) {
            ...
            regionESet = false;
            if( eNotificationRequired() )
                eNotify( new ENotificationImpl( this, Notification.UNSET, CimPackage.LINE__REGION, null, null,
                        oldRegionESet ) );
        }
    }
