 ...
 * <!-- end-model-doc -->
 * @see fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.CimPackage#getVsQpccControlKind()
 * @model
 * @generated
 */
public enum VsQpccControlKind implements Enumerator {
    /**
     * The '<em><b>Pulse Width Modulation</b></em>' literal object.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * <!-- end-model-doc -->
     * @see #PULSE_WIDTH_MODULATION_VALUE
     * @generated
     * @ordered
     */
    PULSE_WIDTH_MODULATION( 1, "pulseWidthModulation", "pulseWidthModulation" ),
     ...
     * @ordered
     */
    REACTIVE_PCC( 2, "reactivePcc", "reactivePcc" ),
     ...
     * @ordered
     */
    POWER_FACTOR_PCC( 3, "powerFactorPcc", "powerFactorPcc" ),
     ...
     * @ordered
     */
    VOLTAGE_PCC( 4, "voltagePcc", "voltagePcc" );

    /**
     * The '<em><b>Pulse Width Modulation</b></em>' literal value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     * No explicit control. Pulse-modulation factor is directly set in magnitude (VsConverter.targetPWMfactor) and phase (VsConverter.targetPhasePcc).
     * <!-- end-model-doc -->
     * @see #PULSE_WIDTH_MODULATION
     * @model name="pulseWidthModulation"
     * @generated
     * @ordered
     */
    public static final int PULSE_WIDTH_MODULATION_VALUE = 1;
     ...
     * @ordered
     */
    public static final int REACTIVE_PCC_VALUE = 2;
     ...
     * @ordered
     */
    public static final int POWER_FACTOR_PCC_VALUE = 3;
     ...
     * @ordered
     */
    public static final int VOLTAGE_PCC_VALUE = 4;
    ...
    public static VsQpccControlKind get( String literal ) {
        for( VsQpccControlKind result : VALUES_ARRAY ) {
    ...
    public static VsQpccControlKind get( int value ) {
        switch( value ) {
        case PULSE_WIDTH_MODULATION_VALUE:
