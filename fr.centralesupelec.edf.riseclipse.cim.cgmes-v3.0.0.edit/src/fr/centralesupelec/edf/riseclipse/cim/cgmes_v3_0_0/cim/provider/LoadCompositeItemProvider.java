...
/**
 * This is the item provider adapter for a {@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.LoadComposite} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LoadCompositeItemProvider extends LoadDynamicsItemProvider {
    ...
    protected void addLfacPropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString( "_UI_LoadComposite_lfac_feature" ),
                        getString( "_UI_PropertyDescriptor_description", "_UI_LoadComposite_lfac_feature",
                                "_UI_LoadComposite_type" ),
                        CimPackage.eINSTANCE.getLoadComposite_Lfac(),
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
