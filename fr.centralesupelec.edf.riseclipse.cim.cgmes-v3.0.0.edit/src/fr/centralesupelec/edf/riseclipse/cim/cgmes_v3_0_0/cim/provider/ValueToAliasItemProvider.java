...
/**
 * This is the item provider adapter for a {@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.ValueToAlias} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ValueToAliasItemProvider extends IdentifiedObjectItemProvider {
    /**
     ...
     * @generated
     */
    public ValueToAliasItemProvider( AdapterFactory adapterFactory ) {
    ...
    public Object getImage( Object object ) {
        return overlayImage( object, getResourceLocator().getImage( "full/obj16/ValueToAlias" ) );
    }
    ...
    public String getText( Object object ) {
        String label = ( ( ValueToAlias ) object ).getName();
        return label == null || label.length() == 0 ? getString( "_UI_ValueToAlias_type" )
                : getString( "_UI_ValueToAlias_type" ) + " " + label;
    }
    ...
    public void notifyChanged( Notification notification ) {
        ...
        switch( notification.getFeatureID( ValueToAlias.class ) ) {
