...
/**
 * This is the item provider adapter for a {@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.DiagramStyle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiagramStyleItemProvider extends IdentifiedObjectItemProvider {
    /**
    ...
    public Object getImage( Object object ) {
        return overlayImage( object, getResourceLocator().getImage( "full/obj16/DiagramStyle" ) );
    }
    ...
    public String getText( Object object ) {
        String label = ( ( DiagramStyle ) object ).getName();
        return label == null || label.length() == 0 ? getString( "_UI_DiagramStyle_type" )
                : getString( "_UI_DiagramStyle_type" ) + " " + label;
    }
