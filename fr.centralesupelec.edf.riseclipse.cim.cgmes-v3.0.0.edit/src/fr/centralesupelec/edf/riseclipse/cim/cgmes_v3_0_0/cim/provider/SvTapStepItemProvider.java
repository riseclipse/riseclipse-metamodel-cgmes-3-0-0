...
/**
 * This is the item provider adapter for a {@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.SvTapStep} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SvTapStepItemProvider extends CimObjectWithIDItemProvider {
    /**
     ...
     * @generated
     */
    public SvTapStepItemProvider( AdapterFactory adapterFactory ) {
    ...
    public Object getImage( Object object ) {
        return overlayImage( object, getResourceLocator().getImage( "full/obj16/SvTapStep" ) );
    }
    ...
    public String getText( Object object ) {
        String label = ( ( SvTapStep ) object ).getID();
        return label == null || label.length() == 0 ? getString( "_UI_SvTapStep_type" )
                : getString( "_UI_SvTapStep_type" ) + " " + label;
    }
    ...
    public void notifyChanged( Notification notification ) {
        ...
        switch( notification.getFeatureID( SvTapStep.class ) ) {
