...
/**
 * This is the item provider adapter for a {@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.DCTerminal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DCTerminalItemProvider extends DCBaseTerminalItemProvider {
    /**
     ...
     * @generated
     */
    public DCTerminalItemProvider( AdapterFactory adapterFactory ) {
    ...
    public Object getImage( Object object ) {
        return overlayImage( object, getResourceLocator().getImage( "full/obj16/DCTerminal" ) );
    }
    ...
    public String getText( Object object ) {
        String label = ( ( DCTerminal ) object ).getName();
        return label == null || label.length() == 0 ? getString( "_UI_DCTerminal_type" )
                : getString( "_UI_DCTerminal_type" ) + " " + label;
    }
