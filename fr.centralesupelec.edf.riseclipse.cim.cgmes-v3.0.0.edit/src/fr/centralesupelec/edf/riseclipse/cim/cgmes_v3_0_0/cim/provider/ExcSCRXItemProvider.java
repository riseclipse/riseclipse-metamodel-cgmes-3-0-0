...
/**
 * This is the item provider adapter for a {@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.ExcSCRX} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExcSCRXItemProvider extends ExcitationSystemDynamicsItemProvider {
    ...
    protected void addCswitchPropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString( "_UI_ExcSCRX_cswitch_feature" ),
                        getString( "_UI_PropertyDescriptor_description", "_UI_ExcSCRX_cswitch_feature",
                                "_UI_ExcSCRX_type" ),
                        CimPackage.eINSTANCE.getExcSCRX_Cswitch(),
                        true,
                        false,
                        false,
    ...
    protected void addTatbPropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString( "_UI_ExcSCRX_tatb_feature" ),
                        getString( "_UI_PropertyDescriptor_description", "_UI_ExcSCRX_tatb_feature",
                                "_UI_ExcSCRX_type" ),
                        CimPackage.eINSTANCE.getExcSCRX_Tatb(),
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addRcrfdPropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString( "_UI_ExcSCRX_rcrfd_feature" ),
                        getString( "_UI_PropertyDescriptor_description", "_UI_ExcSCRX_rcrfd_feature",
                                "_UI_ExcSCRX_type" ),
                        CimPackage.eINSTANCE.getExcSCRX_Rcrfd(),
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addEmaxPropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString( "_UI_ExcSCRX_emax_feature" ),
                        getString( "_UI_PropertyDescriptor_description", "_UI_ExcSCRX_emax_feature",
                                "_UI_ExcSCRX_type" ),
                        CimPackage.eINSTANCE.getExcSCRX_Emax(),
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addEminPropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString( "_UI_ExcSCRX_emin_feature" ),
                        getString( "_UI_PropertyDescriptor_description", "_UI_ExcSCRX_emin_feature",
                                "_UI_ExcSCRX_type" ),
                        CimPackage.eINSTANCE.getExcSCRX_Emin(),
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
