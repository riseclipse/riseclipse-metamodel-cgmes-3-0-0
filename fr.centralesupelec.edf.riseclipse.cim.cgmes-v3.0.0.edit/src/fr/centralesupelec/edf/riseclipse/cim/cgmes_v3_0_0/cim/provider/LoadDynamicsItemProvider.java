...
/**
 * This is the item provider adapter for a {@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.LoadDynamics} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LoadDynamicsItemProvider extends IdentifiedObjectItemProvider {
    /**
     ...
     * @generated
     */
    public LoadDynamicsItemProvider( AdapterFactory adapterFactory ) {
    ...
    public Object getImage( Object object ) {
        return overlayImage( object, getResourceLocator().getImage( "full/obj16/LoadDynamics" ) );
    }
    ...
    public String getText( Object object ) {
        String label = ( ( LoadDynamics ) object ).getName();
        return label == null || label.length() == 0 ? getString( "_UI_LoadDynamics_type" )
                : getString( "_UI_LoadDynamics_type" ) + " " + label;
    }
