...
import fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.SetPoint;

/**
 * This is the item provider adapter for a {@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.SetPoint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SetPointItemProvider extends AnalogControlItemProvider {
    /**
     ...
     * @generated
     */
    public SetPointItemProvider( AdapterFactory adapterFactory ) {
    ...
    public Object getImage( Object object ) {
        return overlayImage( object, getResourceLocator().getImage( "full/obj16/SetPoint" ) );
    }
    ...
    public String getText( Object object ) {
        String label = ( ( SetPoint ) object ).getName();
        return label == null || label.length() == 0 ? getString( "_UI_SetPoint_type" )
                : getString( "_UI_SetPoint_type" ) + " " + label;
    }
    ...
    public void notifyChanged( Notification notification ) {
        ...
        switch( notification.getFeatureID( SetPoint.class ) ) {
