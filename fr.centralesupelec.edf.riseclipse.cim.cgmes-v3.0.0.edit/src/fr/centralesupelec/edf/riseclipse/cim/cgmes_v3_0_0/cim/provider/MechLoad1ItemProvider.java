...
/**
 * This is the item provider adapter for a {@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.MechLoad1} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MechLoad1ItemProvider extends MechanicalLoadDynamicsItemProvider {
    /**
     ...
     * @generated
     */
    public MechLoad1ItemProvider( AdapterFactory adapterFactory ) {
    ...
    public Object getImage( Object object ) {
        return overlayImage( object, getResourceLocator().getImage( "full/obj16/MechLoad1" ) );
    }
    ...
    public String getText( Object object ) {
        String label = ( ( MechLoad1 ) object ).getName();
        return label == null || label.length() == 0 ? getString( "_UI_MechLoad1_type" )
                : getString( "_UI_MechLoad1_type" ) + " " + label;
    }
    ...
    public void notifyChanged( Notification notification ) {
        ...
        switch( notification.getFeatureID( MechLoad1.class ) ) {
