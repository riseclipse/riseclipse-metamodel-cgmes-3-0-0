...
/**
 * This is the item provider adapter for a {@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.ACDCConverter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ACDCConverterItemProvider extends ConductingEquipmentItemProvider {
    ...
    protected void addMaxPPropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString( "_UI_ACDCConverter_maxP_feature" ),
                        getString( "_UI_PropertyDescriptor_description", "_UI_ACDCConverter_maxP_feature",
                                "_UI_ACDCConverter_type" ),
                        CimPackage.eINSTANCE.getACDCConverter_MaxP(),
                        true,
                        false,
                        false,
    ...
    protected void addMinPPropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString( "_UI_ACDCConverter_minP_feature" ),
                        getString( "_UI_PropertyDescriptor_description", "_UI_ACDCConverter_minP_feature",
                                "_UI_ACDCConverter_type" ),
                        CimPackage.eINSTANCE.getACDCConverter_MinP(),
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
