...
/**
 * This is the item provider adapter for a {@link fr.centralesupelec.edf.riseclipse.cim.cgmes_v3_0_0.cim.DCGround} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DCGroundItemProvider extends DCConductingEquipmentItemProvider {
    /**
     ...
     * @generated
     */
    public DCGroundItemProvider( AdapterFactory adapterFactory ) {
    ...
    public Object getImage( Object object ) {
        return overlayImage( object, getResourceLocator().getImage( "full/obj16/DCGround" ) );
    }
    ...
    public String getText( Object object ) {
        String label = ( ( DCGround ) object ).getName();
        return label == null || label.length() == 0 ? getString( "_UI_DCGround_type" )
                : getString( "_UI_DCGround_type" ) + " " + label;
    }
    ...
    public void notifyChanged( Notification notification ) {
        ...
        switch( notification.getFeatureID( DCGround.class ) ) {
